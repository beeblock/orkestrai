...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    {
      ...{"id":"creative-video-workflow","title":"Turn a brief into a video","body":"Create a vertical five-second text-to-video draft. This action does not contact fal.ai or spend credit. Open Configure access, save the key in the desktop vault and enable this workspace. Search the allowed models for Seedance 2.5 or another desired endpoint, select it and set budget reservations. Newly published models are not authorized automatically. Select the account and search the model picker for Seedance 2.5. Choose the text-to-video endpoint, enter the prompt and set an explicit duration. Save and estimate, inspect the outgoing data and reservation, then generate. For reference-driven endpoints, bind workspace media to the required input paths before estimating. Wait for Completed, play the Video node and download the original. Check the output under generated/videos. Retry download reuses the remote result without regenerating. Your existing Codex image flows are unchanged.","tags":["fal.ai","Canvas","MP4"]},
    },
    {
