  ...
  changelog: [
    {
      ...
      items: [
        ...
        'The native Code Intelligence Graph safely indexes approved TypeScript, JavaScript, Svelte, and PHP repositories, provides atomic searchable revisions and bounded relationship traversal, renders the same graph in Canvas and Workbench, and exposes it to agents through typed CLI and MCP tools.',
      ],
    },
    {
