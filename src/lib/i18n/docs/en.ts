  ...
  changelog: [
    {
      ...
      items: [
        ...
        'Transparent workflows now validate decoded PNG alpha pixels and automatically repair opaque or fake-checkerboard results up to three times per output; stalled runs expire instead of leaving the guided tour waiting indefinitely.',
