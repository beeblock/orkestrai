  ...
  changelog: [
    {
      ...
      items: [
        ...
        'The compact inspector adds calculations and scrub to numeric fields; fixed, hug, fill, min/max, and complete auto layout; rich typography; multi-selection editing; and a keyboard-accessible Hex/RGB/HSL color and gradient workflow with alpha, eyedropper, document colors, and variable binding.',
      ],
    },
    {
