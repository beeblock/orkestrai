...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      bullets: [
        ...
        'Background removal is always another native image_gen.imagegen edit using only the rejected output as reference and the validator\'s dedicated prompt. With multiple image references, ImageGen first composes the foreground on a uniform white matte and removes that matte in a separate native edit. Machine feedback then identifies any baked background as opaque pixels and escalates the cutout prompt if the correction remains opaque. Python, Pillow, ImageMagick, ffmpeg, remove-bg, generated masks, and local pixel processing are forbidden.',
      ],
    },
    {
