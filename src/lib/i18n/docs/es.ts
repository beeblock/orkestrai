...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Inicia el caso de uso guiado para agregar un nodo Grafo de Código e indexar los repositorios aprobados. Busca un servicio, componente, ruta o método, explica una relación con su procedencia y abre el símbolo exacto en Monaco. Superpone agentes, tareas y Floors activos para exponer conflictos de propiedad y crea un paquete de contexto revisable dentro del presupuesto elegido para el líder, un agente, el Council o una tarea trazable. Compara revisiones y guarda proyecto, vista, filtros, selección, cámara y código abierto como una investigación con nombre. Contratos, Calidad, Búsqueda semántica, Ejecución y Cambios siguen en el mismo grafo, y los agentes usan esas operaciones limitadas mediante MCP sin cargar repositorios completos en la conversación.',
