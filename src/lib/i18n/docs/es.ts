...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Inicia el caso de uso guiado para agregar un nodo Grafo de Código e indexar los repositorios aprobados. Busca un servicio, componente, ruta o método y sigue llamadas y dependencias antes de abrir el código. En Análisis, usa Contratos para APIs entre repositorios, Calidad para hallazgos con confianza explícita, Búsqueda semántica para construir un índice offline por intención y Ejecución para importar LCOV, JUnit, traceback o JSON estructurado confinado. Cobertura, fallos, llamadas observadas y relaciones solo de ejecución aparecen en el mismo grafo sin guardar logs crudos ni secretos. Abre Cambios para el working tree y Floors activos y crea una revisión en Review Center o tarea Kanban. Líderes y especialistas usan la misma evidencia limitada por MCP sin cargar repositorios completos en la conversación.',
      tags: ['Inteligencia de código', 'semántica y ejecución', 'múltiples repositorios'],
    },
    {
  ...
  changelog: [
    {
      ...
      items: [
        ...
        'El índice Semántico offline opcional agrega búsqueda por intención sin clave de API, descarga de modelo ni envío externo de código; los vectores compactos quedan limitados a la revisión actual del grafo.',
