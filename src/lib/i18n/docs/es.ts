  ...
  changelog: [
    {
      ...
      items: [
        ...
        'Los flujos transparentes ahora validan los píxeles alpha del PNG decodificado y corrigen automáticamente resultados opacos o con cuadriculado falso con hasta tres intentos por resultado; los runs detenidos expiran en vez de dejar el tour esperando indefinidamente.',
