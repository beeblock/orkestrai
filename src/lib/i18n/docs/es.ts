...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Inicia el caso de uso guiado para agregar un nodo Grafo de Código e indexar todos los repositorios aprobados explícitamente para el workspace. Busca un servicio, componente, ruta o método, selecciona el resultado y alterna entre quién lo llama y sus dependencias antes de abrir el código relevante. Abre Cambios para inspeccionar el working tree actual y los Floors activos, incluidos símbolos afectados, tests probables y conflictos entre Floors, y usa las acciones del alcance para crear una revisión en Review Center o tarea Kanban. Un líder o especialista usa el mismo grafo y handoff limitados por MCP sin cargar repositorios completos en la conversación.',
