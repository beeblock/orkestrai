...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      bullets: [
        ...
        'La eliminación del fondo siempre es otra edición nativa de image_gen.imagegen que usa solo el resultado rechazado como referencia y el prompt dedicado del validador. Se prohíben Python, Pillow, ImageMagick, ffmpeg, remove-bg, máscaras generadas y el procesamiento local de píxeles.',
      ],
    },
    {
  ...
  changelog: [
    {
      ...
      items: [
        ...
        'Los flujos transparentes ahora validan los píxeles alpha del PNG decodificado y corrigen resultados opacos o con cuadriculado falso mediante otra edición nativa de ImageGen, nunca Python ni procesamiento local de píxeles, con hasta tres intentos por resultado; los runs detenidos expiran en vez de dejar el tour esperando indefinidamente.',
