...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    {
      ...{"id":"creative-video-workflow","title":"Convertir un brief en video","body":"Crea un borrador vertical de cinco segundos desde texto. Esta acción no contacta fal.ai ni gasta créditos. Abre Configurar acceso, guarda la clave en la bóveda y habilita este workspace. Busca Seedance 2.5 u otro endpoint en los modelos permitidos, selecciónalo y define límites de reserva. Los modelos nuevos no reciben autorización automática. Selecciona la cuenta y busca Seedance 2.5 en el selector. Elige el endpoint de texto a video, escribe el prompt y define la duración explícitamente. Guarda y estima, revisa los datos enviados y la reserva y genera. Para endpoints con referencias, vincula los medios a los campos requeridos antes de estimar. Espera Completado, reproduce el nodo Video y descarga el original. Revisa la salida en generated/videos. Reintentar descarga reutiliza el resultado remoto sin generar de nuevo. Los flujos de imágenes existentes con Codex no cambian.","tags":["fal.ai","Canvas","MP4"]},
    },
    {
