  ...
  changelog: [
{
  ...
  "items": [
    ...
    "Los adaptadores corrigen la detección de ventanas/PID en Linux, argumentos PowerShell, textos y atajos en Windows, y coordenadas de pantallas y capturas en macOS. La apertura usa aplicaciones registradas; destinos no compatibles fallan explícitamente.",
