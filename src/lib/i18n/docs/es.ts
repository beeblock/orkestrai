  ...
  changelog: [
    {
      ...
      items: [
        ...
        'El inspector compacto añade cálculos y scrub a los campos numéricos; fixed, hug, fill, min/max y auto layout completo; tipografía rica; edición de selección múltiple; y un flujo de color y degradado accesible por teclado en Hex/RGB/HSL con alpha, cuentagotas, colores del documento y vínculo con variables.',
      ],
    },
    {
