...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Inicia el caso de uso guiado para agregar un nodo Grafo de Código e indexar todos los repositorios aprobados explícitamente para el workspace. Busca un servicio, componente, ruta o método, selecciona el resultado y alterna entre quién lo llama y sus dependencias antes de abrir el código relevante. Un líder o especialista usa el mismo grafo limitado por MCP para preparar una explicación de arquitectura o una tarea consciente del impacto sin cargar repositorios completos en la conversación.',
  ...
  changelog: [
    {
      ...
      items: [
        ...
        'El Grafo de Inteligencia de Código nativo indexa de forma segura repositorios TypeScript, JavaScript, Svelte y PHP aprobados, ofrece revisiones atómicas con búsqueda y recorridos limitados, renderiza el mismo grafo en Canvas y Workbench y lo expone a los agentes por CLI y MCP tipados.',
      ],
    },
    {
