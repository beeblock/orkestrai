...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    {
      ...{"id":"creative-video-workflow","title":"Convertir un brief en video","body":"Crea un borrador vertical de cinco segundos desde texto. Esta acción no contacta fal.ai ni gasta créditos. Abre Configurar acceso en el nodo. Guarda la clave fal.ai en la bóveda, activa cuenta y workspace, permite medios externos, selecciona Wan 2.7 y define reservas. Permite agentes solo cuando quieras que agentes con tareas envíen ejecuciones de pago. Selecciona la cuenta, edita la dirección, guarda y estima. Revisa la reserva y posibles aprobaciones de Seguridad antes de Generar video. Para imagen a video, elige Kling y selecciona un nodo Imagen como primer fotograma. Espera Completado, reproduce el nodo Video y descarga el original. Revisa la salida en generated/videos. Reintentar descarga reutiliza el resultado remoto sin generar de nuevo. Los flujos de imágenes existentes con Codex no cambian.","tags":["fal.ai","Canvas","MP4"]},
    },
    {
  ...
  changelog: [
    {"date":"Sin publicar","title":"Orkestrai 0.32.0: flujos nativos de vídeo","summary":"Generación opcional de vídeos con fal.ai en el Canvas y Workbench existentes.","items":["Genera vídeos con Wan 2.7 desde texto o Kling 3 Pro desde Imágenes y Notas seleccionadas. Los controles por modelo y resultados MP4 reutilizables conservan el flujo de imágenes de la suscripción Codex.","Configura credenciales en la bóveda, permisos por workspace y modelo, acceso de agentes, envío de datos, estimaciones, reservas de presupuesto y concurrencia bajo los controles de seguridad existentes.","Recupera ejecuciones persistentes sin duplicar generaciones de pago, solicita cancelación y repite descargas al proyecto. UI manual, CLI/MCP, documentación y tour guiado comparten el mismo flujo.","Exigir una bóveda protegida por el sistema operativo y conservar las credenciales existentes si el archivo es ilegible o está dañado."]},
