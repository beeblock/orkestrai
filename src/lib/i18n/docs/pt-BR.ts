...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Inicie o caso de uso guiado para adicionar um nó Grafo de Código e indexar os repositórios aprovados. Pesquise um serviço, componente, rota ou método, explique uma relação com sua procedência e abra o símbolo exato no Monaco. Sobreponha agentes, tarefas e Floors ativos para expor conflitos de propriedade e monte um pacote de contexto revisável dentro do orçamento escolhido para o líder, um agente, o Council ou uma tarefa rastreável. Compare revisões e salve projeto, visão, filtros, seleção, câmera e código aberto como uma investigação nomeada. Contratos, Qualidade, Busca semântica, Execução e Mudanças continuam no mesmo grafo, e os agentes usam essas operações limitadas pelo MCP sem carregar repositórios inteiros na conversa.',
