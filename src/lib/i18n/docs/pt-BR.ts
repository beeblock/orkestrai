  ...
  changelog: [
    {
      ...
      items: [
        ...
        'O inspector compacto adiciona cálculos e scrub aos campos numéricos; fixed, hug, fill, min/max e auto layout completo; tipografia rica; edição multisseleção; e fluxo acessível por teclado para cor e gradiente em Hex/RGB/HSL com alpha, conta-gotas, cores do documento e vínculo com variável.',
      ],
    },
    {
