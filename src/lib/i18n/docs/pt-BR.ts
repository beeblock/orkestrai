...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Inicie o caso de uso guiado para adicionar um nó Grafo de Código e indexar todos os repositórios explicitamente aprovados para o workspace. Pesquise um serviço, componente, rota ou método, selecione o resultado e alterne entre quem chama e suas dependências antes de abrir o código relevante. Um líder ou especialista usa o mesmo grafo limitado pelo MCP para preparar uma explicação de arquitetura ou uma tarefa consciente do impacto sem carregar repositórios inteiros na conversa.',
  ...
  changelog: [
    {
      ...
      items: [
        ...
        'O Grafo de Inteligência de Código nativo indexa com segurança repositórios TypeScript, JavaScript, Svelte e PHP aprovados, oferece revisões atômicas pesquisáveis e travessias limitadas, renderiza o mesmo grafo no Canvas e Workbench e o expõe aos agentes por CLI e MCP tipados.',
      ],
    },
    {
