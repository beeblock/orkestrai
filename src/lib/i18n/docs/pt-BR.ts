...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      bullets: [
        ...
        'A remoção do fundo é sempre outra edição nativa de image_gen.imagegen usando somente o output rejeitado como referência e o prompt dedicado do validador. Python, Pillow, ImageMagick, ffmpeg, remove-bg, máscaras geradas e processamento local de pixels são proibidos.',
      ],
    },
    {
  ...
  changelog: [
    {
      ...
      items: [
        ...
        'Fluxos transparentes agora validam os pixels alpha do PNG decodificado e corrigem outputs opacos ou com quadriculado falso por outra edição nativa do ImageGen, nunca Python ou processamento local de pixels, em até três tentativas por resultado; runs parados expiram em vez de deixar o tour aguardando indefinidamente.',
