...
export const DOCS_PT: DocsCatalog = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "O pacote Windows inclui um runtime Node de console pinado e verificado por SHA-256. Cada launcher WSL usa esse runtime conhecido quando disponível e mantém o Node da distribuição exata como fallback; nunca chama o Orkestrai.exe gráfico para comandos da ponte, pois processos GUI do Windows não devolvem stdout, stderr ou JSON-RPC de forma confiável ao WSL. Workspaces existentes reparam esse launcher automaticamente quando são abertos. As mensagens entre agentes compartilham uma fila de envio, não um bloqueio exclusivo durante toda a resposta do destinatário. Cada resposta continua vinculada à pergunta exata. Se dois agentes perguntarem um ao outro enquanto um aguarda, a mensagem recíproca explícita pode resolver a chamada em espera sem tratar saída de terminal não relacionada como resposta. Mensagens recebidas pelo Claude durante o trabalho são acompanhadas como comandos enfileirados e associadas quando consumidas. As proteções continuam impedindo despachos obsoletos; o responsável pode reportar trabalho concluído ao líder. Avisos de conclusão aguardam enquanto há um rascunho humano no líder, em vez de expirar após 30 segundos; reabrir ou arquivar a tarefa, trocar o líder ou substituir sua sessão invalida o aviso.",
    },
    {
      id: 'agentes',
...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      bullets: ['Envie o texto completo em uma chamada computer_type. No macOS, eventos Unicode nativos preservam acentos e emoji sem usar a área de transferência. Confira o texto composto e o destinatário antes de enviar; um comando de entrada bem-sucedido não comprova a entrega.', 'Ações vinculadas a uma janela inspecionam o processo alvo em vez de enumerar todos os aplicativos repetidamente. As verificações atualizadas de foco e identidade continuam obrigatórias; mudanças no desktop ou um envio incerto exigem outra observação, não uma repetição cega.'],
  ...
  useCases: [
    {"id":"pdf-ocr","title":"Ler PDFs digitalizados com OCR local","body":"Importe uma nota fiscal digitalizada com valor e data de entrega. Peça ao agente: Busque no Segundo cérebro o valor e o prazo desta nota; cite a página e sinalize incertezas do OCR. Leia o trecho e confira em Abrir original antes de aprovar um pagamento ou plano de entrega. Substitua o PDF, consulte novamente e verifique a nova revisão.","tags":["PDF","OCR","MCP"]},
    {"id":"second-brain","title":"Segundo cérebro: conhecimento conectado","body":"Crie um workspace de campanha. Importe o briefing PDF e o orçamento XLSX, adicione uma nota Campanha com [[briefing.pdf]] e #lancamento e peça ao agente: “Pesquise no Segundo cérebro o orçamento e o prazo, cite a planilha/página e crie um plano.” Altere uma célula do orçamento e consulte novamente para conferir a nova revisão. Após uma tarefa rastreada, peça ao especialista para registrar uma correção reutilizável com evidência, revise em Aprendizado dos agentes e confirme a consulta dessa lição em uma tarefa futura relacionada.","tags":["PDF","XLSX","MCP"]},
    {"id":"creative-video-providers","title":"Escolher o provedor de vídeo sem mudar o fluxo de imagens","body":"Abra Imagens > Fluxo de vídeo no Canvas ou Workbench. Rascunhos existentes continuam na fal.ai. Crie imagens de referência e storyboards pelo fluxo existente da assinatura Codex; esta funcionalidade não transfere a geração de imagens para outro provedor.\n\nNo nó de vídeo, abra Configurar acesso > Nova conta. Escolha o provedor antes de inserir a credencial: chave fal, chave de API BytePlus ModelArk ou KEY_ID:KEY_SECRET da Higgsfield. Salve no cofre criptografado do aplicativo. Depois habilite este workspace, mídia externa, modelos permitidos, reservas por execução/dia em USD e acesso opcional dos agentes. Assinatura do site não implica créditos de API nem acesso ao modelo. Uma conta existente não muda de provedor; crie outra conta.\n\nReferências do vídeo mostra nomes e prévias tanto de mídias do canvas quanto de arquivos do projeto sem nó próprio. Escolha a função (primeiro quadro, último quadro, imagem de referência, vídeo ou áudio) e selecione uma mídia do canvas ou use Escolher do projeto para navegar nas pastas. Ver referência abre uma prévia maior sem sair do fluxo. Os números começam em 1 e representam posições da entrada do modelo, não nomes de arquivo. Detalhes técnicos reúne o mapeamento exato da API e o caminho relativo editável. Visualizar um arquivo não cria um nó nem reescreve o vínculo do agente. Agentes usam os mesmos vínculos; o app não adivinha referências ausentes nem inicia geração paga automaticamente. O adaptador envia ou codifica as entradas na etapa de cotação/geração informada.","tags":["Video","BytePlus","Higgsfield"]},
    {"id":"creative-video-sequences","title":"Montar e exportar uma sequência de vídeo","body":"Abra Imagens > Sequência de vídeo no Canvas ou Workbench. Adicione nós de Vídeo do workspace (MP4, WebM ou MKV). Instale o codificador uma vez pelo nó: o proprietário confirma um download separado e versionado do FFmpeg, verificado por SHA-256. Não exige Homebrew, chave de API nem geração paga.\n\nSelecione um clipe na lista vertical. Mova para cima/baixo, ajuste entrada/saída, nível do áudio e legenda, depois Salvar. Remover só retira o clipe da sequência. O hash da origem fica fixo; arquivo alterado ou ausente bloqueia a exportação. Escolha saída horizontal, vertical ou quadrada e 24/25/30 fps. O ajuste preserva todo o conteúdo com barras pretas, sem cortar ou esticar. As legendas são gravadas dentro de margens seguras de 10%.\n\nReproduzir sequência mostra os cortes em ordem. Exportar MP4 cria um H.264/AAC em generated/videos/sequences e um nó de Vídeo conectado. Confira imagem e som. A exportação guarda sua revisão e indica quando ficou anterior às edições. Exportando não significa entregue; falhas e interrupções ficam visíveis. Cancelar interrompe o codificador sem alterar origens. Temporários próprios são removidos após sucesso/falha/cancelamento; diretórios abandonados são removidos antes da próxima exportação.\n\nAgentes usam video_workflow_sequences ou orkestrai video sequences com tarefa atribuída. Leia a revisão antes de apply/export; repita pedidos com timeout usando a mesma UUID idempotencyKey. Instalar o runtime é exclusivo do proprietário. Limites: 30 clipes, 10 minutos, dimensões pares de 240 a 1920 por lado, uma exportação por vez, ao menos 3 GB livres e saída limitada. Transfira a sequência com todos os nós de Vídeo de origem. Imagens Codex ImageGen e geração fal continuam separadas; isto monta vídeos entregues, não é outro modelo generativo. Use Tela cheia na prévia para conferir clipes verticais e legendas em tamanho legível e voltar ao mesmo editor.","tags":["Creative","Video","Sequence"]},
    {"id":"creative-reusable-workflows","title":"Reutilizar fluxos criativos e acompanhar a fila","body":"Abra Imagens > Fluxos criativos no Canvas ou Workbench, ou Salvar fluxo no cabeçalho de um Storyboard. Salvar fluxo captura a revisão salva atual, a ordem das cenas, direção, diálogos, duração e enquadramento. Dê um nome e, opcionalmente, selecione um fluxo existente para criar uma nova versão imutável. Edições de cena não salvas não entram na captura. O comando video_workflow_recipes também aceita um grupo com exatamente um storyboard: captura esse quadro, não notas, agentes ou automações independentes. Arquivos, histórico de execução, sessões, credenciais e autorizações de gasto não são salvos no modelo.\n\nNa Biblioteca, escolha uma versão, preencha o briefing/roteiro, a proporção de saída e, opcionalmente, o agente Codex de imagens. Vincule cada entrada nomeada de produto/referência a uma imagem ou vídeo do workspace atual e cada personagem a uma versão local aprovada. Identidades correspondentes podem ser pré-selecionadas pela família, versão e hash exatos. Somente o proprietário pode escolher deliberadamente outro personagem aprovado; agentes devem preservar a identidade salva. Importe o personagem pela biblioteca primeiro, se necessário. O proprietário pode reutilizar fluxos de outro workspace; agentes não podem explorar ou ler outros workspaces.\n\nCriar storyboard editável adiciona conteúdo nativo comum, com novos IDs de cena e sem vínculos a execuções antigas. O roteiro substitui o texto literal {{script}} uma única vez, sem avaliação recursiva; se a direção não tem esse marcador, o briefing é acrescentado. Roteiro obrigatório vazio ou entrada ausente bloqueia a criação. Abra o storyboard, confira cada cena e prepare os rascunhos de imagem/vídeo separadamente. As dimensões de imagem passam pelo fluxo Codex existente; duração e proporção de vídeo precisam ser declaradas pelo endpoint escolhido ou a preparação é interrompida. Geração, validação de alpha, estimativas, orçamento e gates existentes continuam válidos.\n\nA Fila de geração atualiza os estados reais de imagem/vídeo do workspace enquanto estiver aberta. Mostra rascunhos, falhas, posição no provedor, reserva em USD e links dos resultados, sem inventar porcentagens. Abrir fluxo dá acesso aos controles normais de estimativa, permissão, revisão e geração. Cancelar usa o executor existente; Repetir download apenas recupera um resultado remoto já criado. Envios pagos incertos não têm repetição automática. Alguns resultados concluídos não significam que o storyboard inteiro terminou. Excluir uma versão salva não exclui storyboards criados nem arquivos de saída.","tags":["Creative","Storyboard","Queue"]},
    {"id":"creative-brand-kits","title":"Reutilize um kit de marca aprovado","body":"Abra Imagens > Kits de marca no Canvas ou Workbench. Em Este workspace, dê um nome ao kit, escolha cores e valores hexadecimais, adicione imagens nomeadas de logotipo/produto/estilo e escreva briefing, tom de comunicação e regras de uso. Os materiais devem ser arquivos locais PNG, JPEG ou WebP; exporte logotipos vetoriais pelas ferramentas de Design antes. Salve o rascunho antes de aprovar.\n\nRevise os arquivos reais e use Aprovar e fixar kit. A aprovação congela cópias em generated/brands com hashes SHA-256. Versões aprovadas não podem ser editadas ou excluídas como rascunhos; crie uma nova versão para alterar. Revisões concorrentes ou arquivos alterados interrompem a operação, sem sobrescrever outra edição. Paleta e regras também podem formar um kit sem imagens.\n\nUse Biblioteca aprovada > Adicionar kit ao Canvas em qualquer workspace. A versão exata vira um grupo nativo, uma nota de regras e nós de imagem conectados. As cópias independem do projeto original; contas, tokens e autorizações de geração não são transferidos. Conecte a nota e as imagens relevantes aos fluxos existentes de imagem Codex ou vídeo fal, respeitando o limite de referências do modelo. Agentes usam video_workflow_brands para criar/ler/derivar/colocar kits locais; só o usuário aprova ou importa entre workspaces. Os materiais não garantem uma saída generativa idêntica pixel a pixel: revise o resultado.","tags":["Brand","Canvas","Creative"]},
    {"id":"creative-shot-direction","title":"Dirigir enquadramento e movimento de câmera","body":"Abra uma cena do Storyboard ou um Fluxo de vídeo e use Direção de câmera. Escolha enquadramento, ângulo, movimento e ritmo. Os controles persistem na cena e no rascunho de vídeo preparado; rascunhos de imagem recebem enquadramento e ângulo, sem movimento de câmera.\n\nEstes controles expressam intenção criativa no prompt, não uma trajetória garantida. Primeiro e último quadro e outros campos de mídia dependem do contrato declarado pelo endpoint. A duração da cena precisa corresponder exatamente a uma duração suportada; valores incompatíveis ou ambíguos interrompem a preparação, sem encurtar o clipe silenciosamente.\n\nAo trocar de modelo, a direção, os vínculos de personagem e voz, as referências de arquivo e os parâmetros são preservados. Adaptadores incompatíveis recusam a troca; endpoints genéricos exigem corrigir mapeamentos incompatíveis antes da estimativa. Quadros obrigatórios continuam obrigatórios até serem revinculados explicitamente. Agentes usam o mesmo objeto shot nas operações de cena de video_workflow_storyboards e na configuração do vídeo.","tags":["video","creative"]},
    {"id":"creative-actions","title":"Crie uma nova direção a partir de uma imagem","body":"Abra Ações criativas no cabeçalho de um nó Imagem. Escolha Variação, Remover fundo, Alterar região ou Animar. O original nunca é sobrescrito. Cada ação congela os bytes exatos em generated/creative-actions e conecta uma imagem de referência e um novo fluxo nativo. A origem salva inclui nó original, hash e contexto da geração.\n\nVariação e Alterar região aceitam direção e 1–10 resultados. Escolha um agente Codex ou atribua-o no fluxo criado. Para Alterar região, arraste um retângulo na imagem real ou ajuste X, Y, largura e altura nos controles acessíveis por teclado. O servidor confere as dimensões originais. Esse retângulo orienta o prompt; não é uma máscara rígida nem uma promessa de preservar cada pixel externo.\n\nPreparar rascunho não gera nem cobra. Abra o fluxo de imagem e use a assinatura Codex existente; remover fundo exige transparência RGBA real e mantém a validação e reparação existentes, sem editar pixels localmente. Animar cria um rascunho de vídeo: escolha qualquer modelo permitido compatível, associe a imagem congelada e todos os personagens obrigatórios, salve, estime e execute explicitamente. Referência congelada ausente ou alterada bloqueia o uso. Cancelar antes de preparar não cria nada; remover um rascunho nunca apaga o original. Agentes usam video_workflow_assets command=prepare com expectedDigest conferido e edit.operation; as duas interfaces usam a mesma validação.","tags":["ImageGen","Canvas","Video"]},
    {"id":"creative-variants","title":"Compare e aprove variantes criativas","body":"Abra Comparar e revisar no cabeçalho de um nó Imagem ou Vídeo ou em um Storyboard. Mesmo fluxo limita as miniaturas às saídas relacionadas; desative para comparar outros arquivos locais. Escolha A e B nos seletores com pesquisa ou clique em uma miniatura para B. Abrir resultado localiza o nó original no Canvas.\n\nPares de vídeos compartilham reprodução, pausa e avanço até a menor duração comum; alterne o áudio entre A e B. Um vídeo sozinho usa controles nativos. Imagens são exibidas sem cortes. Arquivos ausentes ou que não podem ser reproduzidos não podem ser aprovados. Compare rosto, roupa, enquadramento, idioma e voz real com as referências aprovadas; geração concluída não garante consistência.\n\nEscreva o feedback e escolha Aprovar, Solicitar alterações ou Rejeitar. O histórico preserva cada decisão, autoria, horário, comentário e hash do arquivo. A aprovação vincula os bytes exatos, a origem da geração e as versões congeladas de personagens disponíveis. Alterar o arquivo invalida a decisão; revisões concorrentes exigem recarregamento. Agentes usam video_workflow_assets list/inspect/decide e só podem propor uma decisão, nunca aprovar a própria saída. Essas ações não chamam fal ou ImageGen nem gastam créditos.","tags":["Canvas","Video","Review"]},
    {"id":"creative-storyboard","title":"Planejar cenas em um storyboard nativo","body":"Abra Imagens > Storyboard no Canvas ou Workbench. Adicione uma cena e defina título, direção, diálogo, idioma e duração desejada. Selecione a versão exata do personagem aprovado e as imagens/clipes de referência locais; escolha um executor Codex para gerar imagens. Salve antes de trocar de cena. Duplicar inicia um novo rascunho sem reutilizar vínculos de execução. Arraste as cenas para ordenar ou use Mover para cima/baixo. Remover uma cena preserva seus fluxos e arquivos entregues.\n\nPreparar rascunho de imagem cria um fluxo Codex existente conectado, sem executá-lo. São aceitas até cinco referências, incluindo todas as imagens mestras dos personagens selecionados; referências em excesso geram erro explícito, sem descarte silencioso. Abra o rascunho e use seus controles normais de geração. Preparar rascunho de vídeo cria um fluxo fal nativo sem cobrança. Escolha um endpoint permitido, vincule todos os personagens e referências obrigatórios, confira as capacidades reais de duração/áudio do modelo e use Salvar > Estimar > Gerar. Durações não suportadas são rejeitadas, nunca encurtadas silenciosamente. Preparar a mesma cena sem alterações reutiliza o rascunho vinculado. Para escolher outro rascunho explicitamente, desvincule e prepare novamente.\n\nAlterar uma cena marca seus rascunhos como desatualizados; os resultados permanecem intactos. Edições manuais e video_workflow_storyboards usam o mesmo documento com revisão. Gravações concorrentes falham com conflito; suas edições locais ficam visíveis até você descartar e recarregar. Storyboards copiados mantêm IDs de referências/personagens ausentes para correção local explícita; nunca herdam permissões de contas. Revise imagem e som reais antes de aprovar. Uma referência de voz aprovada não garante que todos os modelos consigam reproduzi-la.","tags":["Storyboard","Codex","fal.ai"]},
    {"id":"companion-orchestration","title":"Um assistente que lembra e agenda trabalho","body":"Comece com uma tarefa ativa atribuída ao agente do Canvas e a autorização existente da conversa no Computer. Peça ajuda em linguagem natural; computer_capabilities informa recursos, configuração e permissões sem ler credenciais. As instruções conectam tarefas, notas, ferramentas publicadas do Laboratório, integrações, fluxos nativos de imagem, TTS e PDF. O agente deve consultar ferramentas existentes antes de propor outra e só pode publicar automaticamente dentro da política já autorizada do Laboratório.\n\nExemplo: \"Toda segunda-feira às 14:00, America/Sao_Paulo, prepare meu relatório semanal e envie o resumo para esta conversa autorizada.\" O agente cria uma rotina prompt_agent existente por automation_save e retorna o id e a próxima ocorrência. Em Automações, Agendamento oferece intervalo ou Calendário com execução única/diária/semanal/mensal, hora local, fuso IANA, dias/data e política de atraso. Ignorar admite 60 segundos; Última permite uma ocorrência recente dentro do atraso configurado, sem uma enxurrada de lembretes perdidos. Horários inexistentes no horário de verão são ignorados; horários repetidos executam uma vez; um dia mensal inexistente é ignorado. O computador deve estar acordado, o workspace carregado e a autorização ativa. Consulte, edite, pause ou cancele na mesma interface de Automações; agentes só editam rotinas próprias vinculadas à tarefa e com revisão atual.\n\nEm Computer > Respostas na conversa, habilite explicitamente Memória privada da conversa. Somente mensagens recebidas observadas após a linha de base e envios nativos bem-sucedidos entram neste diário local separado. Não é memória compartilhada do projeto nem importação de todo o histórico do aplicativo. A retenção vai de 30 a 3650 dias, também limitada a 5000 mensagens/16 MiB por conversa. Até 256 fatos com fontes preservam os trechos citados até serem removidos; o agente pesquisa detalhes antigos sob demanda, sem colocar todo o diário em cada prompt. Histórico permite ao dono pesquisar, revisar fatos e apagar um fato ou toda a memória local. A exclusão não apaga transcrições do provider nem o chat externo. Desabilitar pausa novas gravações; remover a autorização exclui seus registros privados.\n\nPedidos longos continuam rastreáveis após a confirmação de recebimento. Habilite lembretes agendados e resultados de tarefas para aquele contato exato para permitir computer_send sem exigir uma nova mensagem recebida. Ele exige uma tarefa atribuída ou execução de automação como origem, deduplica essa origem após reinícios e usa as mesmas verificações de foco, destinatário, rascunho vazio, limite por hora e risco. Alterar a permissão entre digitar e enviar interrompe a publicação. Mensagens recebidas nunca autorizam novos contatos, aplicativos, arquivos ou compras. Despachar uma rotina e esvaziar o campo de texto não comprovam a entrega do relatório.\n\nartifact_speech reutiliza o TTS configurado para criar WAV no workspace; artifact_report cria PDF; artifact_inspect verifica caminho, formato, tamanho e SHA-256. Imagens nativas mantêm o fluxo Codex existente, sem nova chave de API. Em Computer > Respostas na conversa > Anexos nativos, o dono autoriza o seletor, item de menu opcional, Enviar da prévia, formatos e tamanho para aquele contato. computer_media_send usa o digest recebido ou uma tarefa/execução autorizada, cópia privada imutável e verificações do destinatário exato e nome do arquivo na prévia. Mudar a chave não repete um envio incerto. O original fica intacto; cópias temporárias são limitadas a 100 MiB e expiram após 15 minutos. Receber exige autorização separada: selecione o controle Baixar da mensagem e prefixos opcionais de mídia recebida. computer_media_receive salva em um NOVO caminho autorizado do workspace, valida formato/hash e nunca executa conteúdo recebido nem sobrescreve arquivos. O controle Baixar deve pertencer exclusivamente àquela mensagem. O seletor nativo atualmente atende diálogos padrão anexados à janela no macOS; diálogos personalizados e outros backends não são declarados validados. Upload/download do Portal continua separado, com as permissões existentes do navegador. WAV do TTS é anexo de áudio, não gravação nativa de mensagem de voz. artifact_transcribe usa o STT existente para WAV PCM16; o app instalado também decodifica Ogg/Opus, MP3 e M4A pelo Chromium, limitado a 10 MiB e 10 minutos, sem Python, envio externo, acesso ao microfone ou outra janela. O suporte ao codec é verificado na execução. Preparado, submetido, recebido e entregue são estados diferentes; importar um arquivo não significa compreender seu conteúdo.\n\nA composição interrompida tem uma tentativa limitada de recuperação somente antes de Enviar e para um prefixo exato da resposta autorizada. Inspecionar resposta interrompida permite ao dono conferir um rascunho antigo com falha e autorizar a retomada da requisição original, sem reescrever seu conteúdo nem publicar durante a recuperação. Contato ou rascunho alterado, ou qualquer tentativa registrada de Enviar, continuam bloqueados; recuperação não é entrega.\n\nA criação de ferramentas no Workshop expõe o contrato exato e os limites de publicação concedidos ao agente autenticado. Fixtures de transformação podem verificar expectedOutput antes da publicação automática; use dois exemplos distintos e confira publishedRevision antes de executar.\n\nO foco do editor no macOS aguarda confirmação nativa e pode usar a ação de foco do editor verificado. Popovers do aplicativo preservam a verificação do documento original. Outra interrupção antes de Enviar exige nova inspeção e autorização distinta do dono; publicação incerta nunca é repetida.\n\nEm Computador > Respostas da conversa > Persona e voz, salve nome, instruções do proprietário, idioma, voz/velocidade padrão e estilo público. Texto recebido, áudio transcrito, imagens e memórias privadas são referências, não autorização para mudar persona, destinatários, aplicativos ou arquivos. O app bloqueia padrões reconhecidos de credenciais antes de texto público, fala, relatórios gerados e anexos textuais; erros e auditoria guardam motivo/hash, não o conteúdo rejeitado. Detalhes operacionais podem ser bloqueados e travessões substituídos antes do envio. São camadas de proteção, não DLP universal nem imunidade a prompt injection.\n\nO TTS local oferece F1-F5 e M1-M5 em cada idioma suportado em Configurações > Voz e computer_capabilities (30 ids). Por exemplo, peça pt-BR-m3 em artifact_speech; ids desconhecidos são rejeitados em vez de trocar silenciosamente a voz. Quando omitida, vale a voz configurada para o contato. O STT não mudou. O recebimento autorizado de áudio tenta transcrever localmente após baixar: transcription.state=ready contém texto externo não confiável; unavailable significa tentar artifact_transcribe no arquivo verificado, sem baixar novamente. O texto transcrito é transitório, não é copiado para registros de ação/auditoria. Um WAV anexado continua não sendo uma mensagem de voz nativa gravada.\n\nAnexos nativos tem controles separados de Foto e Documento, configurados pelo proprietário. computer_media_send usa foto para imagens e documento para outros formatos por padrão; sem rota de foto autorizada, falha explicitamente em vez de enviar documento escondido. presentation=document mantém o envio como arquivo de forma explícita. Destinatário, arquivo/hash imutável, identidade da prévia, rascunho vazio e proteção contra envio duplicado continuam obrigatórios. Uma prévia personalizada que não comprova o arquivo é recusada, sem adivinhar por captura.\n\nAgente do Canvas mantém ferramentas autônomas e shell livre; as regras do app não isolam nem auditam ações que contornam a ponte. Conversa restrita é uma inferência separada e opcional do Codex 0.154.x, sem ferramentas, com política do proprietário e apenas mensagens/memória deste contato. Não recebe histórico técnico, shell, patch, navegador, plugins ou MCP. Responde texto, mas não executa agendamentos nem gera/envia mídia. Provider, versão ou WSL não suportados interrompem sem recorrer ao terminal livre. Esse modo limitado não substitui o agente autônomo completo. Permissões do sistema e funcionamento no aplicativo nativo ainda exigem validação local.\n\nO WhatsApp no macOS pode omitir o nome do arquivo na prévia de foto. Nesse caso específico, o Orkestrai exige uma confirmação recente do seletor nativo para o caminho temporário, aplicativo e janela exatos; depois confere novamente o destinatário autorizado, uma única foto, a contagem de um item e a legenda vazia no envio. Uma confirmação de outro arquivo/janela ou uma prévia não verificada é rejeitada. Isso não relaxa as verificações de Documento nem transforma submissão em confirmação de entrega.\n\nUma decisão de não responder também precisa encerrar seu lote despachado da caixa de entrada. Após ler todas as mensagens, o agente usa computer_inbox_acknowledge com batchId/inReplyToDigest exatos e motivo already_answered ou no_response_needed. A decisão fica auditada como skipped com sent=false, não como resposta entregue. Novas mensagens pendentes são preservadas e podem seguir imediatamente; outro contato/tarefa, envio incerto ou lote já respondido não pode ser liberado por esse caminho. Apenas dizer no terminal que não precisa responder deixa a fila pendente.\n\nEm Computer > Respostas na conversa, habilite Foco temporário para envio e Localizar e reabrir este contato automaticamente para autorizar a navegação nativa no macOS. Se outra conversa estiver selecionada, o monitor procura o destinatário exato pela busca nativa e confere o cabeçalho antes de ler mensagens. A preparação do envio repete a conferência se a seleção mudou enquanto o agente elaborava a resposta. computer_open_conversation oferece a mesma operação limitada ao agente responsável; não exige busca manual nem capturas repetidas. Navegar não digita no campo de mensagem nem envia, e tem auditoria separada. Contatos duplicados ambíguos, controles nativos não suportados, concessões revogadas e cabeçalhos não confirmados continuam bloqueados em vez de escolher outra pessoa. O monitor em segundo plano ainda exige o computador acordado e o aplicativo autorizado aberto.","tags":["Computer","Automation","Memory"]},
    {"id":"computer-replies","title":"Respostas automáticas para uma conversa autorizada","body":"Habilite Segurança Delimitada com as capacidades computer e agent. No nó Computador existente, abra Respostas em conversas e leia a janela nativa autorizada. Selecione uma tarefa ativa atribuída, o CABEÇALHO real da conversa (nunca o contato na lista lateral), o campo de mensagem e Enviar. Selecione o prefixo de mensagem recebida exatamente como aparece na acessibilidade nativa, incluindo o remetente; o rótulo deve distinguir recebidas de suas próprias mensagens e idealmente incluir o horário. Defina limites de tamanho e quantidade por hora. Só o usuário cria, habilita ou revoga a autorização; ela não libera publicações no app inteiro.\n\nCrie uma automação Manual habilitada de tipo prompt_agent para o mesmo agente. Automações manuais continuam habilitadas entre eventos; não adicione consultas agendadas. Na observação, selecione a janela nativa exata, tarefa e autorização da conversa, use Automático e ative Monitorar. Mudar o foco para outro app não pausa mais a observação nativa. A leitura continua vinculada ao processo e à janela autorizados; trocar a conversa selecionada, fechar a janela ou revogar o acesso ainda impede o processamento. Observar não traz a janela para a frente, não clica e não digita. A acessibilidade nativa precisa expor mensagens completas e sem ambiguidade; isso não importa por API todo o histórico do aplicativo. Apps sem suporte/Linux não passam silenciosamente para envio automático por coordenadas.\n\nA primeira observação estabelece uma referência. As novas mensagens recebidas e observadas entram numa fila local persistente, inclusive enquanto o agente está ocupado. O intervalo curto configurado agrupa perguntas consecutivas. O evento informa grantId, batchId, inReplyToDigest e TODAS as mensagens do lote. O agente lê em ordem, separa assuntos e responde a cada pergunta usando computer_reply com esses campos, targetId, taskId, idempotencyKey e a resposta completa. Pedidos pendentes ficam na tarefa/notas existentes; aceitar um pedido não significa concluí-lo. A mesma sessão do agente mantém o contexto da conversa. Cada lote comporta até 20 mensagens e 60.000 caracteres; o excedente continua pendente, sem corte silencioso. A fila admite 128 mensagens não resolvidas e bloqueia com erro se encher.\n\nO Orkestrai valida a mensagem nativa recebida antes de digitar. Durante a composição e o envio, destinatário autorizado, permissão, foco e rascunho completo continuam protegidos; a mensagem original não precisa permanecer visível nem manter o mesmo índice no histórico. Mensagens novas continuam pendentes enquanto um lote já recebido é respondido. Rascunhos humanos, destinatário alterado, autorização revogada ou entrada ambígua interrompem a operação. No macOS, a digitação nativa direcionada ao processo atualiza o campo real; editores multilinha usam Shift+Return para as quebras, nunca uma quebra sem modificador. Processo, janela e limites continuam verificados durante a entrada. Um comando bem-sucedido confirma a submissão nativa do lote, não entrega/leitura. Falha parcial ou incerta fica bloqueada para inspeção; não repita nem afirme que nada foi enviado sem conferir.\n\nO painel mostra mensagens pendentes, estado do observador e tempo local medido separadamente do tempo de geração do provider. O texto da fila é salvo no banco local do app, fora do repositório do workspace: mensagens não resolvidas permanecem até serem tratadas; até 64 mensagens submetidas ficam como contexto por no máximo 14 dias enquanto o monitoramento roda. Até 4.096 hashes recentes evitam observações duplicadas. A auditoria guarda contagens/hashes, não texto da conversa; transcripts dos providers têm retenção própria. Reiniciar recupera mensagens já observadas e enfileiradas, mas não garante recuperar o que a interface nativa nunca expôs. Respostas de texto não autorizam anexos, acesso a arquivos ou geração a pedido do contato; a entrega de imagens geradas exige integração própria autorizada pelo dono. Builds locais continuam ad-hoc; permissões do sistema pertencem ao usuário e nunca são contornadas.","tags":["Computer","Automation","Audit"]},
    {"id":"computer-observation","title":"Monitorar um app do desktop com armazenamento limitado","body":"O modo automático prefere texto da acessibilidade nativa sem capturas PNG. Use computer_read e computer_interact com condições para controles conhecidos; preserve destinatário, rascunho completo e gate de publicação. O painel mostra a fonte real e o tempo local. Interfaces sem suporte usam a alternativa visual. A latência do provider é adicional.\n\nA observação por acessibilidade nativa e computer_read no macOS/Windows não exigem que a janela esteja em primeiro plano. No macOS, o fallback visual passivo captura a janela selecionada pelo ID sem ativá-la. O fallback por região da tela em outros backends ainda exige primeiro plano para não capturar outro app que cubra a janela. Essa mudança não remove as proteções de foco da digitação/publicação nem garante acesso a conteúdo que o app não exponha. Respostas de texto autorizadas usam controles nativos direcionados ao processo nos adaptadores compatíveis de macOS/Windows, sem mouse ou teclado global. Janela, destinatário, rascunho, autorização e envio único continuam obrigatórios. Entrada global e diálogos nativos de arquivos ainda exigem primeiro plano. Falhas na validação anterior a qualquer entrada nativa mantêm o lote recuperável; um envio incerto nunca é repetido automaticamente. Apps nativos, navegadores externos e Portais gerenciados exigem controles e autorização próprios; testar um não certifica os demais nem futuras mudanças de interface.\n\nNo macOS, abra Computador > Respostas na conversa e habilite Foco temporário para envio para o contato exato. A opção vem desativada e somente o usuário pode alterá-la. computer_reply e computer_send podem então trazer a janela autorizada para frente durante a composição e o envio protegidos. Digitação, cliques recentes ou modificadores pressionados adiam a entrada. O aplicativo e a janela anteriores são restaurados, exceto se o usuário mudar o foco; alvos fechados ou substituídos não são adivinhados. Uma falha de restauração é auditada sem repetir a mensagem. A observação continua em segundo plano. Essa autorização cobre envio de texto, não diálogos de arquivo nem controle irrestrito do desktop; permissões, gates de publicação e recuperação de envios incertos continuam obrigatórios.","tags":["Computer","Automation","Audit"]},
    {
      id: 'leader-team',
    ...
    {
      ...{"id":"creative-video-workflow","title":"Transformar um briefing em vídeo","body":"Crie um diretor Codex, um briefing de cena e um fluxo de imagens. A ferramenta image_gen.imagegen existente cria as referências do personagem/storyboard; a fal.ai não gera imagens. Execute o fluxo de imagens Codex existente. Aguarde duas Imagens validadas e confira o personagem e a cena. Aprove a identidade visual antes de pedir um vídeo pago; imagens rejeitadas não são referências-mestras. Crie um rascunho de vídeo de cinco segundos sem contatar a fal nem gastar créditos. Os próximos passos vinculam o personagem e as referências aprovadas antes de gerar. Abra Configurar acesso, salve a chave no cofre do desktop e abra Permissões do workspace. Habilite o workspace, o envio de referências e Permitir que agentes com tarefas gerem vídeos ao delegar. A autorização vale por workspace e conta para todos os nós de vídeo permitidos, independentemente de o agente ser Claude ou Codex. Escolha modelos e limites de reserva, depois Salvar. Novos modelos e outros workspaces não são autorizados automaticamente. Abra Biblioteca de personagens no nó de vídeo. Salve aparência e caminhos das imagens aprovadas; escolha um áudio aprovado do workspace ou um ID de voz existente com sua conta e endpoints compatíveis. Defina idioma e estilo da fala. Salve, revise e use Aprovar e bloquear. Alterações posteriores exigem Nova versão; agentes não podem aprovar nem sobrescrever versões bloqueadas. Abra o menu Imagens, escolha Personagens e arraste um personagem aprovado para uma área vazia do Canvas de destino ou use Adicionar ao Canvas. A biblioteca é compartilhada entre workspaces locais. O Orkestrai copia todas as imagens bloqueadas e o áudio de voz, preservando versão e hash, e cria uma Nota de identidade e Imagens de referência agrupadas, sem alterar a origem. IDs de voz do provider mantêm o vínculo com a conta original, mas credenciais e permissões do workspace nunca são copiadas. O Workbench oferece a mesma biblioteca e o comando Adicionar ao Canvas. Agentes podem adicionar personagens locais aprovados; importar de outro workspace exige o usuário. Escolha um endpoint autorizado de referência para vídeo, como Seedance 2.5, vincule a versão bloqueada do personagem e mapeie suas imagens e voz nos campos do modelo. Inclua falas e direção sonora, habilite áudio nativo e defina a duração. Salve, estime, confira dados enviados e reserva, e gere. Voz incompatível ou referências alteradas interrompem antes de cobrar. Aguarde Concluído, reproduza o nó de Vídeo e baixe o original. Confira a saída em generated/videos. Tentar baixar novamente reaproveita o resultado remoto sem gerar de novo. Os fluxos existentes de imagens via Codex não mudam. Compare rosto, proporções, roupa e voz com as referências bloqueadas. Gerado não significa consistência aprovada; clipes separados não são editados automaticamente em um filme. Escolha o personagem aprovado pelo nome: a cena mostra imagens-mestras e amostra de voz e associa todas as referências às entradas convencionais declaradas pelo modelo. Nenhuma referência é descartada para caber. O mapeamento avançado continua disponível para contratos diferentes. Digite @ em Direção ou use Inserir referência de personagem para inserir um nome salvo no formato @{nome}; ele permanece vinculado ao ID exato da versão. Remover um personagem citado ou usar um nome desconhecido bloqueia a geração em vez de mudar o sujeito silenciosamente. Os agentes podem solicitar a mesma associação conservadora com video_workflow_characters command=binding e a configuração atual.\n\nGuarde histórico de aprovação, nomes de provedores, atribuição e informações internas em Notas de produção; elas ficam no personagem e não são acrescentadas ao prompt. Aparência e estilo de voz são instruções enviadas ao modelo: inclua apenas características visuais, sotaque, timbre e ritmo, sem comentários internos ou falas. Escreva as falas na direção da cena. Confira o prompt efetivo e ouça o clipe gerado; separar instruções não garante que o modelo as obedeça. Crie uma nova versão para corrigir notas no campo errado em um personagem bloqueado.","tags":["fal.ai","Canvas","MP4"]},
    },
    {
  ...
  changelog: [
    {"date":"Próxima versão","title":"Orkestrai: nova experiência de Canvas e Workbench","summary":"Interface mais limpa, com ações de um clique, movimento suave e leitura confortável.","items":["Menus e janelas abrem com suavidade e fecham mais rápido; superfícies usam elevação do tema em vez de bordas duras; todos os controles compartilham o mesmo anel de foco; nenhum texto fica abaixo de 11px e toda animação respeita a preferência de movimento reduzido do sistema.","Barra lateral do Canvas redesenhada: linhas mais calmas, seleção clara, ações que aparecem ao apontar ou focar, lixeira para apagar e criação de pasta no próprio lugar.","Ferramentas do Canvas agrupadas por finalidade; minimapa e zoom não ficam mais sob a barra de ferramentas; mensagens do canvas aparecem acima da barra e podem ser dispensadas.","Pontos de partida com um clique: criar ou reabrir um workspace quando nenhum está aberto e adicionar agente, nota, quadro de tarefas, árvore de arquivos ou preset de time quando o canvas está vazio.","Molduras, cabeçalhos, ações, seleção e pontos de conexão dos nós refinados; renomeie um nó pelo teclado com Enter ou F2.","Notificações e janelas seguem todos os temas do app, e o botão de ditado fica discreto até ser apontado, focado ou usado.","Mostra “1 selecionado” quando um único nó está selecionado.","Corrige superfícies e textos de Computador, Integrações, Oficina de ferramentas, Storyboard, Sequência e Conhecimento que usavam cores inexistentes do tema.","Terminal: controles de voz reunidos num grupo compacto que aparece ao apontar ou focar e fica visível durante a gravação; o prompt rápido destaca o foco e o botão de enviar acende quando há texto.","Notas: escolha a cor por um único botão em vez de seis bolinhas no cabeçalho; o texto usa fonte de leitura e a moldura acompanha a cor da nota.","Tarefas: mova cartões pelo menu Mover para ou com Alt+setas, edite com Enter e veja as ações secundárias só ao apontar ou focar; colunas, contagens e áreas de soltar ficaram mais claras.","Workbench: árvore com linhas de 30px, seleção neutra com indicador, grupo Centrais identificado, ações ao apontar ou focar e contagens em mono; abas com linha de acento na ativa e fechar sempre visível nela; cabeçalho com trilha legível e estados vazios com próxima ação.","Rodapé de uso do Workbench com mini medidores por janela, cor por limite e porcentagens alinhadas.","Central de controle: atividades em linguagem clara (por exemplo, “Estado atualizado · Maestro”), categorias traduzidas, métricas destacadas e alternância Atividade/Comunicações deslizante.","Painéis laterais do Canvas (Andares, Portas, Papéis e Presets) com a mesma moldura: título com ícone e descrição, fechar sempre no mesmo lugar e entrada suave; cartões de preset mais calmos, com a ação principal destacada ao apontar.","Configurações: a navegação marca a seção visível; minimapa e controles de zoom viram interruptores; tamanho de fonte, espaçamento e fonte do editor usam controles deslizantes com o valor ao lado; tamanhos de novos nós mostram a unidade no campo; bordas do canvas e abas do Workbench usam seletores segmentados.","Central de Providers: filtro com contagens, cartões neutros com elevação (o estado fica no selo), Abrir canvas como ação da linha e formulário de perfil com foco claro.","Como usar: o índice marca a seção visível e casos de uso longos começam recolhidos com Ler mais. Skills & MCPs: largura estável, seções com elevação e abas no padrão do app.","Paletas de comando: ícones próprios para cada comando, linhas sem repetições, campo de busca maior, item destacado sempre visível ao navegar e rodapé com atalhos de teclado.","Apresentação inicial: o idioma em uso aparece marcado como Atual e recebe o foco, em vez de a primeira opção parecer selecionada.","Arraste qualquer ferramenta de criação do dock até o canvas para criar o nó exatamente onde soltar; o canvas destaca a área de soltar e as dicas das ferramentas explicam clicar e desenhar ou arrastar.","Workbench: arraste itens da barra lateral direto para qualquer painel para abri-los ali.","Removido o contorno azul de redimensionamento que cobria o anel de seleção de um nó selecionado.","Árvore de arquivos, diff, editor, Git e portal repaginados: campo de busca de verdade, chips de status do Git coloridos e com nome legível, ações de arquivo no hover ou foco, esqueletos de carregamento, estados vazios e de erro com o próximo passo, campo de commit que acende quando está pronto, cabeçalho do portal mais leve com as configurações no chip de controle e sliders para as dimensões do dispositivo.","A lista de arquivos do Git agora rola em vez de ficar cortada, as confirmações do editor não aparecem mais em vermelho e a árvore de arquivos não mostra mais \"pasta vazia\" antes de carregar.","Textos compactos da interface mantêm o tamanho previsto quando o componente também define uma cor de texto, em vez de voltar a um tamanho maior.","Nós criativos repaginados: solte uma imagem direto em um nó de imagem vazio, veja se o executor de imagens está pronto e por que Gerar está indisponível, reordene clipes da sequência arrastando, escolha proporções do storyboard e estilos de forma com controles segmentados, chaves e sliders, e tenha estados claros de carregamento, vazio e erro com uma ação de recuperação.","Formas ganham uma barra flutuante que libera as alças de redimensionamento, e grupos ganham moldura tracejada, rótulo elevado e renomeação pelo teclado com Enter ou F2.","Nós de automação repaginados: defina as rodadas do loop com um slider e a escrita de arquivos com uma chave ao lado de um botão Rodar claro, reordene os passos do fluxo arrastando ou com as setas do teclado, ajuste o limiar de uso com um slider e a janela com um controle segmentado, e leia o uso em medidores com horário de reset.","Cliente de API mais calmo: cores do tema em tudo, lista de requests com ações no hover, estados vazios com a ação Adicionar request, alternâncias segmentadas, chips de status com ícones e requests ordenados por arraste no runner.","\"Nenhum dado de uso informado\" aparece em tom neutro em vez de verde, e o botão Adicionar request do cliente de API vazio cria o request na raiz.","Títulos e descrições truncados terminam com reticências em vez de quebrar para uma segunda linha.","Grafo de código, Segundo cérebro, documento, dispositivo, computador e oficina de ferramentas repaginados: barra do grafo em uma linha com Indexar como única ação principal, estatísticas que aparecem depois de indexar, sliders para profundidade e orçamento de tokens, fontes com ícone de tipo e tags, estados vazios de documento e dispositivo com o próximo passo, configurações do computador agrupadas em cartões com as seções raras recolhidas e chips de status das ferramentas com nomes legíveis de executor.","O botão Indexar do grafo de código volta a ser clicável no estado vazio, e o painel de ferramentas do dispositivo não fica mais cortado em nós estreitos.","Centrais do Workbench repaginadas: a Central de revisão ganha linhas de arquivo calmas com preparar e descartar no hover, um popover de comentário ancorado e estados claros de carregamento e vazio; Fluxos de trabalho, Anotações e Atenção ganham filtros segmentados com contagem e um campo de busca de verdade; Huddles mostram um chip Ao vivo, linhas de participante clicáveis e avatares nas mensagens; Automações revelam as ações da linha no hover e mostram receitas em cartões; o limite de execuções simultâneas é um slider; e o explorador e a barra de arquivos seguem a barra lateral do Workbench.","Categorias de receita e eventos de auditoria de segurança traduzidos, campos do cofre com rótulo visível, hash de revisão longo contido na coluna de Anotações e riscos de revisão com ícone de alerta em vez de um check.","O ícone de Huddles aparece nos itens abertos e nas abas do Workbench, e o cabeçalho do painel mostra o nome de Huddles e Fluxos de trabalho em vez do tipo interno.","Todos os diálogos seguem a mesma anatomia: título com uma linha de descrição, campos agrupados com dicas, erros em um bloco consistente e rodapé com a ação principal por último. Runtimes, modos, plataformas e inteligência de código usam controles segmentados; os limites do agente usam stepper, slider e um campo em minutos; as configurações do workspace são divididas em seções; e os temas são escolhidos em cartões de prévia com amostras de cor.","Downloads de atualização aparecem em uma pílula flutuante com progresso, os passos do tour são anunciados a leitores de tela e as opções raras de compartilhamento ficam em Avançado.","A aba de escopo ativa do diálogo de comandos do terminal agora aparece selecionada."]},
    {"date":"24 de setembro de 2026 · 0.35.0","title":"Orkestrai 0.35.0: Ler PDFs digitalizados com OCR local","summary":"OCR local permite que usuários e agentes pesquisem PDFs digitalizados.","items":["Leia PDFs digitalizados e mistos offline com OCR embutido em português, inglês e espanhol, preservando originais e citações por página.","Mostre confiança do OCR, arquivos protegidos e extração parcial; reindexe PDFs antigos automaticamente e isole o extrator em outro processo."]},
    {"date":"23 de setembro de 2026 · 0.34.0","title":"Orkestrai 0.34.0: Segundo cérebro: conhecimento conectado","summary":"Transforme documentos e trabalho do projeto em conhecimento reutilizável com fontes.","items":["Pesquise o conhecimento do workspace com citações, etiquetas, backlinks e grafo próprio no Canvas e Workbench.","Importe nós de documento arrastando PDF, Markdown, XLSX, CSV e outros arquivos; preserve originais e veja os limites de extração e atualização.","Preserve lições de agentes entre providers, com reflexão por tarefa, consulta limitada e modos automático/revisão/desativado na UI, CLI e MCP.","Explore uma rede de conhecimento 2D/3D colorida e interativa, com atualizações ao vivo do workspace e dos arquivos vinculados, câmera e posições estáveis, detalhes das fontes e liberação de recursos fora de tela. Mantenha os detalhes de hover ao passar por rótulos e após arrastar uma fonte. Gestos de pinça também funcionam quando um dedo começa sobre um rótulo."]},
    {"date":"23 de setembro de 2026 · 0.33.0","title":"Orkestrai 0.33.0: mais provedores de vídeo","summary":"Use fal.ai, BytePlus ModelArk ou Higgsfield com contas, contratos e orçamentos separados.","items":["Adicionar BytePlus ModelArk e Higgsfield como provedores explícitos de vídeo, junto da fal.ai, com contratos próprios, contas no cofre e roteamento persistente da fila. Fluxos fal e imagens Codex permanecem compatíveis.","Expor seleção coerente de provedor/conta/modelo, tarifas públicas datadas e cotação configurada da Higgsfield. Preservar referências obrigatórias ao trocar provedor explicitamente e bloquear credenciais cruzadas e reenvios pagos duplicados.","Documentar limites de upload, cancelamento e referências nos três idiomas; compartilhar contratos com agentes, storyboards e onboarding guiado.","Parar as conexões elásticas após estabilizarem, sem reiniciar a própria animação. Limitar física sem convergência, reutilizar índices de conexões e adiar a pintura de imagens e fluxos fora da tela, sem descarregar agentes nem alterar arquivos originais.","Exibir referências de vídeo com nomes e prévias para nós do canvas e arquivos do projeto. Navegar nas pastas, ampliar a prévia e manter caminhos/mapeamentos da API nos detalhes técnicos, sem alterar vínculos dos agentes. Alinhar os controles de conta e modelo."]},
    {"date":"19 de setembro de 2026 · 0.32.0","title":"Orkestrai 0.32.0: fluxos nativos de vídeo","summary":"Geração opcional de vídeos pela fal.ai no Canvas e Workbench existentes.","items":["Aguardar o campo de mensagens do Claude antes de entregar roles, tarefas iniciais ou Enter automático. A confirmação de confiança da pasta fica sob controle do usuário, sem selecionar No, exit por acidente; tempo de espera esgotado não é registrado como entrega.","Separar notas de produção e procedência de aprovação/versão do prompt; distinguir instruções do personagem e falas da cena sem alterar referências congeladas.","Exiba descrições, exemplos e padrões do provedor para usuários e agentes; edite parâmetros aninhados, identifique parâmetros incompatíveis ao trocar o modelo e compare tarifas-base da conta no seletor antes de estimar a execução.","Isolar os formulários criativos por diálogo para que a restauração de vários nós não reutilize identificadores de personagem, conta, permissões, marca ou receita. Manter a rolagem das configurações de vídeo com conta, abas e ações fixas, inclusive em janelas compactas.","Manter os menus pesquisáveis de modelos e referências dentro da janela, inclusive nos campos próximos ao rodapé de um diálogo.","Reservar os campos de imagem e voz do personagem ao anexar mídias da cena, oferecendo as próximas entradas livres sem conflitar com identidades aprovadas.","Informar o tamanho exato das respostas de mídia do workspace para que as prévias de voz determinem a duração sem aguardar o fim da reprodução.","Fechar a confirmação do encoder de vídeo após a aprovação para que o download concluído não deixe o editor de sequência bloqueado por uma sobreposição.","Pesquise todo o catálogo de vídeos da fal.ai, incluindo Seedance 2.5, com contratos específicos, parâmetros aninhados, múltiplas referências de imagem/vídeo/áudio e permissões por workspace. Rascunhos Wan/Kling e fluxos de imagem Codex continuam compatíveis.","Configure credenciais no cofre, permissões por workspace e modelo, acesso dos agentes, envio de dados, estimativas, reservas de orçamento e concorrência sob os controles de segurança existentes.","Retome execuções persistentes sem duplicar gerações pagas, solicite cancelamento e repita downloads para o projeto. UI manual, CLI/MCP, documentação e tour guiado usam o mesmo fluxo. Os arquivos nativos de vídeo/áudio preservam seus bytes e cada saída confere novamente permissões de pasta e rede. Geração rejeitada pelo provedor é uma falha, não um download recuperável; a reserva de orçamento é mantida.","Salve e bloqueie versões de aparência e voz aprovadas pelo usuário. Reutilize referências imutáveis com hashes pela UI e pelos agentes; bloqueie vínculos incompatíveis e trocas silenciosas de identidade antes da geração paga. Arraste personagens aprovados entre workspaces com todas as referências visuais e de voz, cópias locais independentes e nós nativos agrupados; credenciais e permissões não são transferidas. Confira imagens-mestras e voz, associe entradas compatíveis automaticamente e insira referências nomeadas sem descartar arquivos nem trocar identidades silenciosamente.","Exigir um cofre protegido pelo sistema operacional e preservar credenciais existentes quando o arquivo estiver ilegível ou inválido.","Encontre skills da curadoria por nomes com espaços ou hífens mesmo quando o catálogo online estiver indisponível.","Mantenha as configurações da conta de vídeo bloqueadas durante o carregamento para que respostas atrasadas não apaguem edições ou avisos de validação. Preserve edições e seleções das janelas criativas durante atualizações do workspace.","Adiciona storyboards nativos com cenas ordenadas, diálogo, personagens aprovados, referências e rascunhos de imagem/vídeo vinculados. Compartilha controle de revisão com CLI/MCP; preserva resultados e mostra dependências ausentes ou desatualizadas, sem execução paga automática.","Compare variantes de imagem e vídeo com reprodução sincronizada e histórico de revisão imutável vinculado ao hash. Arquivos alterados invalidam a aprovação; agentes podem propor, mas não se autoaprovar.","Adiciona variação de imagem, remoção de fundo com alpha real, alterações anotadas e rascunhos de animação. Preserva originais e origem congelada nos fluxos Codex de imagem e fal de vídeo existentes.","Salve a direção de cada cena sem perder referências ou vínculos de voz.","Versione paletas, logotipos, produtos e regras criativas e coloque os materiais exatos em qualquer workspace.","Salve roteiros versionados com entradas nomeadas e recrie storyboards editáveis sem copiar autorizações de execução.","Ordene, corte e legende vídeos existentes sem alterar os arquivos originais.","Exclua políticas, auditoria, eventos de integração e ferramentas vinculados ao workspace na ordem de dependência, sem deixar o Canvas parcialmente removido; preserve outros workspaces e arquivos do projeto.","Atualizar a dependência de serialização para corrigir negação de serviço por entradas malformadas."]},
    {"date":"16 de setembro de 2026","title":"Orkestrai 0.31.5: comunicação entre agentes e seleção no terminal","summary":"Comunicação confiável entre agentes e seleção precisa no terminal.","items":["Entregar mensagens entre agentes sem aguardar toda a resposta do modelo. Mensagens recíprocas desbloqueiam quem aguarda, mensagens recebidas pelo Claude durante o trabalho mantêm o vínculo com o transcript, e avisos válidos de conclusão continuam disponíveis ao líder.","Alinhar as coordenadas do mouse ao zoom do Canvas ao arrastar, selecionar palavras e usar telas com escala."]},
    {
    ...
    },
    {
      ...
      "items": [
        ...
        "Restaura o arrasto de arquivos externos: imagens soltas no espaço livre do Canvas viram nós de referência persistentes separados; arquivos soltos sobre um agente viram anexos do prompt, sem envio automático. Reconhece o arrasto protegido antes de soltar e preserva as entradas durante o upload.",
    ...
    {
      "date": "16 de setembro de 2026 · 0.31.0",
      "title": "Orkestrai 0.31.0: assistentes contínuos no desktop",
      "summary": "Monitoramento de conversas, memória privada e trabalho agendado com acesso controlado pelo usuário.",
      "items": [
        "Monitore conversas autorizadas no desktop em segundo plano e acione o agente do Canvas quando chegarem mensagens. No macOS, a navegação automática opcional reabre o contato aprovado.",
        "Processe mensagens recebidas em lotes persistentes, inclusive após reabrir o chat, com verificação do texto completo, proteção contra envio duplicado e recuperação de digitação interrompida.",
        "Configure persona, idioma e voz de cada assistente, com memória privada opcional da conversa, preferências com fontes, controles de retenção e exclusão.",
