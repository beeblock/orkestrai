...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Adicione um Diretor Criativo Codex, uma nota de Briefing Visual e um fluxo Gerar imagens. Use uma conta ou assinatura do Codex autenticada com ImageGen disponível; nenhuma chave de API da OpenAI é necessária. Você pode configurar o grafo manualmente ou pedir ao Diretor Criativo conectado para criar o fluxo, escrever ou revisar a direção, adicionar e ordenar referências do workspace, solicitar até dez resultados, executar o run completo e devolver cada output validado ao canvas. O agente usa sua tool nativa image_gen.imagegen com referenced_image_paths, copia cada resultado para o destino atribuído e conclui uma execução rastreável. Poses aprovadas podem alimentar o próximo ramo sem perder contexto do prompt ou procedência. Um líder que não seja Codex pode coordenar o trabalho, mas precisa conectar ou delegar a execução ao Codex.',
