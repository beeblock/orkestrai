...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    {
      ...{"id":"creative-video-workflow","title":"Transformar um briefing em vídeo","body":"Crie um rascunho vertical de cinco segundos a partir de texto. Esta ação não contata a fal.ai nem gasta créditos. Abra Configurar acesso no nó. Salve a chave fal.ai no cofre do app, ative conta e workspace, permita mídia externa, selecione Wan 2.7 e defina limites de reserva. Permita agentes somente se quiser que agentes com tarefas enviem execuções pagas. Selecione a conta, edite a direção, salve e estime. Confira a reserva e eventuais gates de Segurança antes de Gerar vídeo. Para imagem-para-vídeo, escolha Kling e selecione um nó de Imagem como primeiro quadro. Aguarde Concluído, reproduza o nó de Vídeo e baixe o original. Confira a saída em generated/videos. Tentar baixar novamente reaproveita o resultado remoto sem gerar de novo. Os fluxos existentes de imagens via Codex não mudam.","tags":["fal.ai","Canvas","MP4"]},
    },
    {
  ...
  changelog: [
    {"date":"Não publicado","title":"Orkestrai 0.32.0: fluxos nativos de vídeo","summary":"Geração opcional de vídeos pela fal.ai no Canvas e Workbench existentes.","items":["Gere vídeos com Wan 2.7 a partir de texto ou Kling 3 Pro a partir de Imagens e Notas selecionadas. Controles específicos por modelo e resultados MP4 reutilizáveis preservam o fluxo de imagens da assinatura Codex.","Configure credenciais no cofre, permissões por workspace e modelo, acesso dos agentes, envio de dados, estimativas, reservas de orçamento e concorrência sob os controles de segurança existentes.","Retome execuções persistentes sem duplicar gerações pagas, solicite cancelamento e repita downloads para o projeto. UI manual, CLI/MCP, documentação e tour guiado usam o mesmo fluxo.","Exigir um cofre protegido pelo sistema operacional e preservar credenciais existentes quando o arquivo estiver ilegível ou inválido."]},
