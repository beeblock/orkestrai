  ...
  changelog: [
    {
      ...
      items: [
        ...
        'Fluxos transparentes agora validam os pixels alpha do PNG decodificado e corrigem automaticamente outputs opacos ou com quadriculado falso em até três tentativas por resultado; runs parados expiram em vez de deixar o tour aguardando indefinidamente.',
