...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      bullets: ['Remover um nó de Imagem ou Vídeo o retira do inventário atual do Canvas, não da pasta do projeto. Os agentes devem atualizar esse inventário e não recuperar nem reutilizar mídias removidas por mensagens antigas, pastas ou histórico de geração sem seu pedido explícito. As consultas de fluxos de imagem e as leituras de vídeo por agentes retornam resultados atuais por padrão. Para consultar gerações antigas explicitamente, use includeHistory=true (vídeo: input.includeHistory; CLI de imagem: --include-history). Consultar o histórico não autoriza reutilizá-lo. O acesso ao código-fonte e às versões da biblioteca de personagens/marcas escolhidas explicitamente não muda. Exclusões que falham continuam visíveis com um aviso, em vez de desaparecerem apenas da tela.'],
  ...
  useCases: [
    ...
    },
    {
      ...
      body: "Crie um Portal com nome, abra o site desejado e faça login manualmente. O time tem acesso Ler e interagir por padrão, sem selecionar cada agente. Mantenha o segundo plano desabilitado. Para este exemplo de automação com proteção adicional, opcionalmente ative Delimitado em Automações > Segurança, autorize o host e as categorias necessárias, mantendo envios e ações destrutivas sob gates. O uso interativo normal do Portal não exige essa configuração. Atribua uma tarefa para ler a página, preencher um campo não sensível e preparar um relatório sem enviá-lo. Acompanhe as mudanças na mesma página. Confira o envio pendente em Segurança > Gates, aprove e retome a mesma execução da ferramenta ou aguarde a automação. Expanda Auditoria e Oficina > Execuções para conferir as etapas concluídas. Pause o Portal para testar a revogação. Habilite o segundo plano apenas quando desejar, usando auditoria e histórico para acompanhar.",
  ...
  changelog: [
    {"date":"26 de setembro de 2026 · 0.36.2","title":"Orkestrai 0.36.2: mídia no Canvas e entrega no projeto","summary":"Inventário fiel ao Canvas e entrega de vídeos editados pelos agentes dentro do projeto configurado.","items":["Mantenha os nós visíveis quando a exclusão falhar, inclusive em seleções parciais, e preserve as conexões em falhas de persistência.","Consultas padrão dos agentes não incluem caminhos históricos de mídia. O histórico exige uma consulta explícita; mídia removida não é reutilizada automaticamente e os arquivos do projeto permanecem intactos.","Agentes com tarefa podem adicionar vídeos editados do projeto como nós reproduzíveis, sem gerar, enviar a provedores ou mover arquivos. Valide formato, tamanho e hash opcional, preserve os limites do projeto e reutilize nós existentes em novas tentativas.","Exponha a pasta configurada do projeto, distinguindo os caminhos do host e do WSL. Briefings, prompts, fontes da montagem, renders e entregas finais ficam nela por padrão; mudar de diretório no terminal não troca o workspace autenticado."]},
    {"date":"26 de setembro de 2026 · 0.36.1","title":"Orkestrai 0.36.1: acesso aos Portais e correções do Canvas","summary":"Restaure o acesso do time aos Portais, importe vídeos locais e mantenha navegadores alinhados.","items":["Restaura o uso do Portal sem exigir política de autonomia ativa nem tarefa atribuída. Portais novos e não configurados permitem todo o time, incluindo novos recrutas; listas explícitas, modos manual/somente leitura, pausas, campos protegidos, políticas ativadas e auditoria continuam valendo.","Arraste MP4, M4V, MOV, WebM ou MKV de até 64 MB como nós nativos de Vídeo, com reprodução e referências reutilizáveis nos fluxos. Preserve o arquivo original e as permissões dos provedores.","Mantenha as páginas dos portais atrás dos controles do Canvas. Use uma prévia temporária dentro do nó ao arrastar, mover, ampliar ou redimensionar e retome a mesma página sem recarregar a sessão."]},
    {"date":"24 de setembro de 2026 · 0.36.0","title":"Orkestrai 0.36.0: uma nova experiência no Canvas e Workbench","summary":"Ferramentas nativas renovadas, manipulação direta e navegação mais clara no desktop e no Remote.","items":["Arraste ferramentas do dock para o Canvas e itens da árvore para painéis do Workbench. Reordene etapas de fluxos, clipes, camadas/páginas de design e requisições dos runners diretamente.","Comece workspaces vazios com ações de um clique, confira a disponibilidade do executor de imagens e solte referências sobre nós de imagem vazios.","Canvas e Workbench renovados com molduras consistentes, ferramentas agrupadas, abas legíveis, medidores compactos de uso e ações acessíveis pelo teclado.","Editor de Design com novas barras, árvore de camadas, controles de seleção e propriedades, incluindo cores, layout e alinhamento/operações booleanas para múltiplas seleções.","Menus, modais, indicadores de foco, superfícies por tema e movimento reduzido consistentes; textos compactos, contraste, estados selecionados e mensagens de recuperação mais claros.","Configurações e Central de Providers com sliders, switches e seletores segmentados. Melhorias na pesquisa de comandos e navegação da documentação.","Controles de voz dos terminais, notas, Kanban, Git, portais, coleções de API, fluxos criativos, automações e centrais do Workbench refinados, preservando dados e contratos dos agentes.","Conexão Remote guiada por etapas, status e dicas de recuperação, com compartilhamento e telas conectadas consistentes.","Site e READMEs atualizados com gravações reais do aplicativo e novas demonstrações do produto.","O Canvas vazio aceita ferramentas, arquivos e personagens arrastados; os controles de execução dos fluxos ficam acessíveis e a indexação do grafo volta a responder.","Correções de cortes no rodapé dos runners, listas de arquivos Git e painéis compactos de dispositivos; controles de seleção e valores do Design permanecem visíveis.","Estados selecionados de permissões/escopos, tooltips de ícones e badges legíveis restaurados; ausência de dados de uso não aparece como estado saudável.","O Remote continua responsivo quando há um huddle compartilhado; rótulos ambíguos, traduções e ações de estados vazios corrigidos."]},
    {"date":"24 de setembro de 2026 · 0.35.0","title":"Orkestrai 0.35.0: Ler PDFs digitalizados com OCR local","summary":"OCR local permite que usuários e agentes pesquisem PDFs digitalizados.","items":["Leia PDFs digitalizados e mistos offline com OCR embutido em português, inglês e espanhol, preservando originais e citações por página.","Mostre confiança do OCR, arquivos protegidos e extração parcial; reindexe PDFs antigos automaticamente e isole o extrator em outro processo. Normalize os caminhos dos recursos PDF embutidos para Windows, macOS e Linux."]},
