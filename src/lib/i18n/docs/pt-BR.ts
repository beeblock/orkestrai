...
Header: Authorization = Bearer {{accessToken}}`,
  ...
  useCases: [
    ...
    {
      ...{"id":"creative-video-workflow","title":"Transformar um briefing em vídeo","body":"Crie um rascunho vertical de cinco segundos a partir de texto. Esta ação não contata a fal.ai nem gasta créditos. Abra Configurar acesso, salve a chave no cofre do desktop e habilite este workspace. Pesquise Seedance 2.5 ou outro endpoint nos modelos permitidos, selecione e defina limites de reserva. Modelos novos não recebem autorização automaticamente. Selecione a conta e pesquise Seedance 2.5 no seletor de modelos. Escolha o endpoint de texto para vídeo, escreva o prompt e defina a duração explicitamente. Salve e estime, confira os dados enviados e a reserva e gere. Em endpoints com referências, vincule as mídias do workspace aos campos exigidos antes de estimar. Aguarde Concluído, reproduza o nó de Vídeo e baixe o original. Confira a saída em generated/videos. Tentar baixar novamente reaproveita o resultado remoto sem gerar de novo. Os fluxos existentes de imagens via Codex não mudam.","tags":["fal.ai","Canvas","MP4"]},
    },
    {
