...
export const TOURS_PT: Tour[] = [
  ...
  {
    ...{"id":"creative-video-workflow","icon":"Images","title":"Transformar um briefing em vídeo","tagline":"Prepare, autorize e acompanhe a entrega de vídeo no Canvas existente.","steps":[{"id":"draft","title":"Preparar o fluxo","body":"Crie um rascunho vertical de cinco segundos a partir de texto. Esta ação não contata a fal.ai nem gasta créditos.","action":{"kind":"createVideoWorkflow","title":"Transformar um briefing em vídeo","prompt":"Um vídeo vertical de cinco segundos de uma xícara de café de cerâmica numa mesa escura limpa, iluminação lateral suave, aproximação lenta da câmera, sem texto."},"check":{"kind":"nodeExists","nodeType":"videoWorkflow","titleIncludes":"Transformar um briefing em vídeo"}},{"id":"access","title":"Autorizar este workspace","body":"Abra Configurar acesso no nó. Salve a chave fal.ai no cofre do app, ative conta e workspace, permita mídia externa, selecione Wan 2.7 e defina limites de reserva. Permita agentes somente se quiser que agentes com tarefas enviem execuções pagas."},{"id":"generate","title":"Revisar e gerar","body":"Selecione a conta, edite a direção, salve e estime. Confira a reserva e eventuais gates de Segurança antes de Gerar vídeo. Para imagem-para-vídeo, escolha Kling e selecione um nó de Imagem como primeiro quadro."},{"id":"result","title":"Verificar o MP4 real","body":"Aguarde Concluído, reproduza o nó de Vídeo e baixe o original. Confira a saída em generated/videos. Tentar baixar novamente reaproveita o resultado remoto sem gerar de novo. Os fluxos existentes de imagens via Codex não mudam."}]},
  },
  {
