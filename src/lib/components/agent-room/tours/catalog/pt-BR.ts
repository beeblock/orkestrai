...
export const TOURS_PT: Tour[] = [
  ...
  {
    ...{"id":"creative-video-workflow","icon":"Images","title":"Transformar um briefing em vídeo","tagline":"Prepare, autorize e acompanhe a entrega de vídeo no Canvas existente.","steps":[{"id":"draft","title":"Preparar o fluxo","body":"Crie um rascunho vertical de cinco segundos a partir de texto. Esta ação não contata a fal.ai nem gasta créditos.","action":{"kind":"createVideoWorkflow","title":"Transformar um briefing em vídeo","prompt":"Um vídeo vertical de cinco segundos de uma xícara de café de cerâmica numa mesa escura limpa, iluminação lateral suave, aproximação lenta da câmera, sem texto."},"check":{"kind":"nodeExists","nodeType":"videoWorkflow","titleIncludes":"Transformar um briefing em vídeo"}},{"id":"access","title":"Autorizar este workspace","body":"Abra Configurar acesso, salve a chave no cofre do desktop e habilite este workspace. Pesquise Seedance 2.5 ou outro endpoint nos modelos permitidos, selecione e defina limites de reserva. Modelos novos não recebem autorização automaticamente."},{"id":"generate","title":"Revisar e gerar","body":"Selecione a conta e pesquise Seedance 2.5 no seletor de modelos. Escolha o endpoint de texto para vídeo, escreva o prompt e defina a duração explicitamente. Salve e estime, confira os dados enviados e a reserva e gere. Em endpoints com referências, vincule as mídias do workspace aos campos exigidos antes de estimar."},{"id":"result","title":"Confira a mídia entregue","body":"Aguarde Concluído, reproduza o nó de Vídeo e baixe o original. Confira a saída em generated/videos. Tentar baixar novamente reaproveita o resultado remoto sem gerar de novo. Os fluxos existentes de imagens via Codex não mudam."}]},
  },
  {
