...
export const TOURS_PT: Tour[] = [
  ...
  {
    ...{"id":"creative-video-workflow","icon":"Images","title":"Transformar um briefing em vídeo","tagline":"Prepare, autorize e acompanhe a entrega de vídeo no Canvas existente.","steps":[{"id":"storyboard","title":"Preparar o storyboard com Codex","body":"Crie um diretor Codex, um briefing de cena e um fluxo de imagens. A ferramenta image_gen.imagegen existente cria as referências do personagem/storyboard; a fal.ai não gera imagens.","action":[{"kind":"createAgent","title":"Diretor Criativo de Vídeo","provider":"codex","position":{"x":40,"y":60}},{"kind":"createNote","title":"Briefing do personagem e vídeo","content":"Planeje uma cena vertical de cinco segundos para este personagem. Preserve rosto, proporções, jaqueta e paleta aprovados. Aproximação suave da câmera; o personagem ergue uma xícara e diz em português brasileiro: \"Um novo começo.\" Ambiente de cafeteria e som suave da xícara. As imagens do storyboard devem usar apenas o fluxo Codex existente. Use fal para vídeo só após o usuário aprovar referências, voz e gasto. Salve um rascunho de personagem com referência real de voz ou ID de voz compatível, peça ao usuário para bloqueá-lo e reutilize essa versão exata em todas as cenas. Nunca substitua personagem, voz ou idioma.","position":{"x":40,"y":600}},{"kind":"createImageWorkflow","title":"Referências aprovadas do personagem","prompt":"Crie duas imagens verticais 9:16 separadas do MESMO personagem original: um mascote geométrico vermelho com jaqueta verde, olhos redondos expressivos e proporções corporais consistentes. Imagem 1: imagem-mestra limpa de corpo inteiro. Imagem 2: o mesmo personagem em uma cafeteria aconchegante, segurando uma xícara de cerâmica. Preserve exatamente identidade, roupa, paleta e estilo. Sem texto ou colagem.","count":2,"transparentBackground":false,"outputPreset":"tiktok","outputDirectory":"generated/images/video-storyboard","filePrefix":"character-reference","position":{"x":650,"y":60}},{"kind":"connect","fromTitle":"Diretor Criativo de Vídeo","toTitle":"Referências aprovadas do personagem"},{"kind":"connect","fromTitle":"Briefing do personagem e vídeo","toTitle":"Referências aprovadas do personagem"}],"check":{"kind":"nodeExists","nodeType":"imageWorkflow","titleIncludes":"Referências aprovadas do personagem"}},{"id":"storyboard-review","title":"Gerar e revisar as referências","body":"Execute o fluxo de imagens Codex existente. Aguarde duas Imagens validadas e confira o personagem e a cena. Aprove a identidade visual antes de pedir um vídeo pago; imagens rejeitadas não são referências-mestras.","action":{"kind":"runImageWorkflow","title":"Referências aprovadas do personagem"},"check":{"kind":"imageWorkflowSucceeded","title":"Referências aprovadas do personagem","minOutputs":2}},{"id":"draft","title":"Preparar o fluxo","body":"Crie um rascunho de vídeo de cinco segundos sem contatar a fal nem gastar créditos. Os próximos passos vinculam o personagem e as referências aprovadas antes de gerar.","action":{"kind":"createVideoWorkflow","title":"Transformar um briefing em vídeo","prompt":"Planeje uma cena vertical de cinco segundos para este personagem. Preserve rosto, proporções, jaqueta e paleta aprovados. Aproximação suave da câmera; o personagem ergue uma xícara e diz em português brasileiro: \"Um novo começo.\" Ambiente de cafeteria e som suave da xícara. As imagens do storyboard devem usar apenas o fluxo Codex existente. Use fal para vídeo só após o usuário aprovar referências, voz e gasto. Salve um rascunho de personagem com referência real de voz ou ID de voz compatível, peça ao usuário para bloqueá-lo e reutilize essa versão exata em todas as cenas. Nunca substitua personagem, voz ou idioma."},"check":{"kind":"nodeExists","nodeType":"videoWorkflow","titleIncludes":"Transformar um briefing em vídeo"}},{"id":"access","title":"Autorizar este workspace","body":"Abra Configurar acesso, salve a chave no cofre do desktop e abra Permissões do workspace. Habilite o workspace, o envio de referências e Permitir que agentes com tarefas gerem vídeos ao delegar. A autorização vale por workspace e conta para todos os nós de vídeo permitidos, independentemente de o agente ser Claude ou Codex. Escolha modelos e limites de reserva, depois Salvar. Novos modelos e outros workspaces não são autorizados automaticamente."},{"id":"model-controls","title":"Revise parâmetros e preços do modelo","body":"Selecione a conta e pesquise no seletor de modelos para comparar tarifas-base e suas unidades. Leia descrições e padrões do modelo, escolha sugestões ou edite listas e objetos aninhados. Confira a reescrita do prompt: ela pode alterar sua direção. Resolva parâmetros incompatíveis após trocar o modelo e use Estimar custo para a configuração completa. Consultar contratos ou preços não gera nem cobra."},{"id":"character-lock","title":"Aprovar personagem e voz","body":"Abra Biblioteca de personagens no nó de vídeo. Salve aparência e caminhos das imagens aprovadas; escolha um áudio aprovado do workspace ou um ID de voz existente com sua conta e endpoints compatíveis. Defina idioma e estilo da fala. Salve, revise e use Aprovar e bloquear. Alterações posteriores exigem Nova versão; agentes não podem aprovar nem sobrescrever versões bloqueadas. Guarde histórico de aprovação, nomes de provedores, atribuição e informações internas em Notas de produção; elas ficam no personagem e não são acrescentadas ao prompt. Aparência e estilo de voz são instruções enviadas ao modelo: inclua apenas características visuais, sotaque, timbre e ritmo, sem comentários internos ou falas. Escreva as falas na direção da cena. Confira o prompt efetivo e ouça o clipe gerado; separar instruções não garante que o modelo as obedeça. Crie uma nova versão para corrigir notas no campo errado em um personagem bloqueado."},{"id":"character-reuse","title":"Reutilizar em outro workspace","body":"Abra o menu Imagens, escolha Personagens e arraste um personagem aprovado para uma área vazia do Canvas de destino ou use Adicionar ao Canvas. A biblioteca é compartilhada entre workspaces locais. O Orkestrai copia todas as imagens bloqueadas e o áudio de voz, preservando versão e hash, e cria uma Nota de identidade e Imagens de referência agrupadas, sem alterar a origem. IDs de voz do provider mantêm o vínculo com a conta original, mas credenciais e permissões do workspace nunca são copiadas. O Workbench oferece a mesma biblioteca e o comando Adicionar ao Canvas. Agentes podem adicionar personagens locais aprovados; importar de outro workspace exige o usuário."},{"id":"generate","title":"Revisar e gerar","body":"Escolha um endpoint autorizado de referência para vídeo, como Seedance 2.5, vincule a versão bloqueada do personagem e mapeie suas imagens e voz nos campos do modelo. Inclua falas e direção sonora, habilite áudio nativo e defina a duração. Salve, estime, confira dados enviados e reserva, e gere. Voz incompatível ou referências alteradas interrompem antes de cobrar. Escolha o personagem aprovado pelo nome: a cena mostra imagens-mestras e amostra de voz e associa todas as referências às entradas convencionais declaradas pelo modelo. Nenhuma referência é descartada para caber. O mapeamento avançado continua disponível para contratos diferentes. Digite @ em Direção ou use Inserir referência de personagem para inserir um nome salvo no formato @{nome}; ele permanece vinculado ao ID exato da versão. Remover um personagem citado ou usar um nome desconhecido bloqueia a geração em vez de mudar o sujeito silenciosamente. Os agentes podem solicitar a mesma associação conservadora com video_workflow_characters command=binding e a configuração atual."},{"id":"result","title":"Confira a mídia entregue","body":"Aguarde Concluído, reproduza o nó de Vídeo e baixe o original. Confira a saída em generated/videos. Tentar baixar novamente reaproveita o resultado remoto sem gerar de novo. Os fluxos existentes de imagens via Codex não mudam. Compare rosto, proporções, roupa e voz com as referências bloqueadas. Gerado não significa consistência aprovada; clipes separados não são editados automaticamente em um filme."},{"id":"import-videos","title":"Importar um vídeo existente","body":"Arraste um ou mais arquivos MP4, M4V, MOV, WebM ou MKV (até 64 MB cada) para uma área vazia do Canvas. Cada arquivo vira um nó de Vídeo separado no local do drop, com nome original e controles de reprodução; não vira documento de conhecimento. O Orkestrai copia o original sem alterações para .orkestrai/media/videos no projeto. No fluxo de vídeo, adicione uma Entrada de mídia do workspace, escolha um campo do modelo compatível com vídeo e selecione o nó pelo nome. Agentes usam o mesmo nó/caminho. Importar não gera nem envia nada ao provedor; os gates de consentimento, conta e orçamento continuam valendo ao executar o fluxo. O suporte a contêiner e codec varia: se a reprodução local não estiver disponível, baixe o original; os limites de referências de cada provedor continuam valendo.\n\nEntrega de vídeo editado: peça ao agente para adicionar renders/final.mp4 ao Canvas. Com uma tarefa atribuída, ele usa video_workflow_import com input.path e title/expectedSha256 opcionais, ou orkestrai video import --task <taskId> --input '{\"path\":\"renders/final.mp4\",\"title\":\"Montagem final\"}'. Arquivos MP4/M4V/MOV/WebM/MKV existentes de até 256 MiB viram nós de Vídeo, sem copiar, transcodificar, enviar a provedores ou gerar novamente. Uma nova tentativa reutiliza o nó existente no mesmo andar. Renders de montagem local não exigem chave de provedor nem autorização de geração paga. Arquivos fora do projeto configurado precisam de alias de repositório aprovado pelo usuário; caminhos absolutos, travessia e links simbólicos para fora são recusados. Limites de tamanho/codec para referências de provedores continuam valendo. Remover o nó preserva o arquivo original e não autoriza reutilização automática. O agente deve conferir o id do nó retornado antes de declarar a entrega. orkestrai list e video_workflow_list mostram a pasta real do projeto (workingDir no host, wslWorkingDir no WSL). Briefings, prompts, assets, projetos de montagem, renders e exportações finais ficam nela, salvo outro destino explicitamente escolhido por você. Dar cd no terminal ou arrastar um arquivo de outra pasta não troca o workspace. Se o projeto for diferente, resolva essa divergência antes de gerar; não grave silenciosamente em um antigo workspace de testes."}]},
  },
  {
    ...
    steps: [
      {
        ...
        body: 'Eu adiciono um único agente Codex para controlar todas as etapas. Use uma conta ou assinatura Codex autenticada com ImageGen disponível; nenhuma chave de API é necessária. Você também pode soltar suas imagens no espaço livre do Canvas para criar referências, ou sobre o agente para anexá-las ao prompt. Soltar nunca envia o prompt automaticamente.',
