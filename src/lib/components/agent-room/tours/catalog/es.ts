...
export const TOURS_ES: Tour[] = [
  ...
  {
    ...{"id":"creative-video-workflow","icon":"Images","title":"Convertir un brief en video","tagline":"Prepara, autoriza y sigue la entrega de video en el Canvas existente.","steps":[{"id":"storyboard","title":"Preparar el storyboard con Codex","body":"Crea un director Codex, un brief de escena y un flujo de imágenes. La herramienta image_gen.imagegen existente genera las referencias del personaje/storyboard; fal.ai no genera imágenes.","action":[{"kind":"createAgent","title":"Director Creativo de Video","provider":"codex","position":{"x":40,"y":60}},{"kind":"createNote","title":"Brief del personaje y video","content":"Planifica una escena vertical de cinco segundos. Conserva rostro, proporciones, chaqueta y paleta aprobados. Acercamiento suave de cámara; el personaje levanta una taza y dice en español latinoamericano: \"Un nuevo comienzo.\" Ambiente de cafetería y un sonido suave de taza. Las imágenes del storyboard solo usan el flujo Codex existente. Usa fal para video después de que el usuario apruebe referencias, voz y gasto. Guarda un borrador de personaje con referencia real de voz o ID compatible, pide al usuario que lo bloquee y reutiliza esa versión exacta en cada escena. Nunca sustituyas personaje, voz ni idioma.","position":{"x":40,"y":600}},{"kind":"createImageWorkflow","title":"Referencias aprobadas del personaje","prompt":"Crea dos imágenes verticales 9:16 separadas del MISMO personaje original: una mascota geométrica roja con chaqueta verde, ojos redondos expresivos y proporciones corporales constantes. Imagen 1: imagen maestra limpia de cuerpo completo. Imagen 2: el mismo personaje en una cafetería cálida, sosteniendo una taza de cerámica. Conserva exactamente identidad, vestuario, paleta y estilo. Sin texto ni collage.","count":2,"transparentBackground":false,"outputPreset":"tiktok","outputDirectory":"generated/images/video-storyboard","filePrefix":"character-reference","position":{"x":650,"y":60}},{"kind":"connect","fromTitle":"Director Creativo de Video","toTitle":"Referencias aprobadas del personaje"},{"kind":"connect","fromTitle":"Brief del personaje y video","toTitle":"Referencias aprobadas del personaje"}],"check":{"kind":"nodeExists","nodeType":"imageWorkflow","titleIncludes":"Referencias aprobadas del personaje"}},{"id":"storyboard-review","title":"Generar y revisar las referencias","body":"Ejecuta el flujo Codex existente. Espera dos Imágenes validadas y revisa personaje y escena. Aprueba la identidad visual antes de solicitar un video de pago; las imágenes rechazadas no son referencias maestras.","action":{"kind":"runImageWorkflow","title":"Referencias aprobadas del personaje"},"check":{"kind":"imageWorkflowSucceeded","title":"Referencias aprobadas del personaje","minOutputs":2}},{"id":"draft","title":"Preparar el flujo","body":"Crea un borrador de video de cinco segundos sin contactar fal ni gastar créditos. Los siguientes pasos vinculan el personaje y las referencias aprobadas antes de generar.","action":{"kind":"createVideoWorkflow","title":"Convertir un brief en video","prompt":"Planifica una escena vertical de cinco segundos. Conserva rostro, proporciones, chaqueta y paleta aprobados. Acercamiento suave de cámara; el personaje levanta una taza y dice en español latinoamericano: \"Un nuevo comienzo.\" Ambiente de cafetería y un sonido suave de taza. Las imágenes del storyboard solo usan el flujo Codex existente. Usa fal para video después de que el usuario apruebe referencias, voz y gasto. Guarda un borrador de personaje con referencia real de voz o ID compatible, pide al usuario que lo bloquee y reutiliza esa versión exacta en cada escena. Nunca sustituyas personaje, voz ni idioma."},"check":{"kind":"nodeExists","nodeType":"videoWorkflow","titleIncludes":"Convertir un brief en video"}},{"id":"access","title":"Autorizar este workspace","body":"Abre Configurar acceso, guarda la clave en la bóveda y abre Permisos del workspace. Habilita el workspace, el envío de referencias y Permitir que agentes con tareas generen videos al delegar. La autorización se aplica por workspace y cuenta a todos los nodos de vídeo permitidos, sea el agente Claude o Codex. Elige modelos y límites de reserva y pulsa Guardar. No se autorizan automáticamente nuevos modelos ni otros workspaces."},{"id":"model-controls","title":"Revisa los parámetros y precios del modelo","body":"Selecciona la cuenta y busca en el selector para comparar tarifas base y sus unidades. Lee las descripciones y valores del modelo, elige sugerencias o edita listas y objetos anidados. Comprueba la reescritura del prompt: puede cambiar tu dirección. Resuelve incompatibilidades tras cambiar de modelo y estima el coste de la configuración completa. Consultar contratos o precios no genera ni cobra."},{"id":"character-lock","title":"Aprobar personaje y voz","body":"Abre Biblioteca de personajes en el nodo de video. Guarda apariencia y rutas de imágenes aprobadas; elige un audio aprobado del workspace o un ID de voz existente con su cuenta y endpoints compatibles. Define idioma y estilo. Guarda, revisa y usa Aprobar y bloquear. Los cambios posteriores requieren Nueva versión; los agentes no pueden aprobar ni sobrescribir versiones bloqueadas. Guarda el historial de aprobación, nombres de proveedores, atribución e información interna en Notas de producción; permanecen en el personaje y no se añaden al prompt. Apariencia y estilo vocal son instrucciones enviadas al modelo: incluye solo rasgos visibles, acento, timbre y ritmo, sin comentarios internos ni diálogo. Escribe las frases en la dirección de la escena. Revisa el prompt efectivo y escucha el clip; separar instrucciones no garantiza que el modelo las respete. Crea una nueva versión para corregir notas mal ubicadas en un personaje bloqueado."},{"id":"character-reuse","title":"Reutilizar en otro workspace","body":"Abre el menú Imágenes, elige Personajes y arrastra un personaje aprobado a un área vacía del Canvas de destino o usa Añadir al Canvas. La biblioteca se comparte entre workspaces locales. Orkestrai copia todas las imágenes bloqueadas y la muestra de voz, conserva versión y hash, y crea una Nota de identidad e Imágenes de referencia agrupadas sin modificar el origen. Los IDs de voz conservan su cuenta original, pero nunca se copian credenciales ni permisos del workspace. Workbench ofrece la misma biblioteca y Añadir al Canvas. Los agentes pueden colocar personajes locales aprobados; importar desde otro workspace requiere al usuario."},{"id":"generate","title":"Revisar y generar","body":"Selecciona un endpoint autorizado de referencia a video, como Seedance 2.5, vincula la versión bloqueada del personaje y asigna sus imágenes y voz a los campos del modelo. Incluye diálogos y dirección sonora, activa audio nativo y define duración. Guarda, estima, revisa datos y reserva, y genera. Las voces incompatibles o referencias modificadas se bloquean antes de cobrar. Elige el personaje aprobado por nombre: la escena muestra imágenes maestras y muestra de voz y asigna todas las referencias a entradas convencionales declaradas por el modelo. No se descarta ninguna referencia para ajustarse. La asignación avanzada sigue disponible para contratos diferentes. Escribe @ en Dirección o usa Insertar referencia de personaje para insertar un nombre guardado como @{nombre}; permanece vinculado al ID exacto de la versión. Eliminar un personaje citado o usar un nombre desconocido bloquea la generación, sin cambiar el sujeto silenciosamente. Los agentes pueden solicitar la misma asignación conservadora con video_workflow_characters command=binding y la configuración actual."},{"id":"result","title":"Revisa el archivo entregado","body":"Espera Completado, reproduce el nodo Video y descarga el original. Revisa la salida en generated/videos. Reintentar descarga reutiliza el resultado remoto sin generar de nuevo. Los flujos de imágenes existentes con Codex no cambian. Compara rostro, proporciones, vestuario y voz con las referencias bloqueadas. Generado no significa consistencia aprobada; los clips separados no se editan automáticamente como película."},{"id":"import-videos","title":"Importar un vídeo existente","body":"Arrastra uno o varios archivos MP4, M4V, MOV, WebM o MKV (hasta 64 MB cada uno) a un área vacía del Canvas. Cada archivo se convierte en un nodo de Vídeo separado en el lugar del drop, con su nombre original y controles de reproducción; no es un documento de conocimiento. Orkestrai copia el original sin cambios a .orkestrai/media/videos en el proyecto. En un flujo de vídeo, añade una Entrada multimedia del workspace, elige un campo compatible con vídeo y selecciona el nodo por su nombre. Los agentes usan el mismo nodo/ruta. Importar no genera ni envía nada al proveedor; los controles de consentimiento, cuenta y presupuesto se aplican al ejecutar el flujo. El soporte de contenedores y códecs varía: si la reproducción local no está disponible, descarga el original; siguen vigentes los límites de referencias de cada proveedor."}]},
  },
  {
    ...
    steps: [
      {
        ...
        body: 'Añado un único agente Codex para controlar todas las etapas. Usa una cuenta o suscripción Codex autenticada con ImageGen disponible; no se necesita una clave de API. También puedes soltar tus imágenes en el espacio libre del Canvas para crear referencias, o sobre el agente para adjuntarlas a su prompt. Soltar nunca envía el prompt automáticamente.',
      ...
      },
      {
        ...
        body: "Hazlo por mí ejecuta la última etapa. El caso de uso solo termina después de que tres slides estén persistidos y visibles en el Canvas. El grafo final preserva cada prompt, referencia, archivo, conexión, ejecución y origen. Después de generar, pide al Director Creativo que abra generated/images/xyz-carousel. Abre la carpeta en el gestor de archivos del host mediante fs_open_folder, sin habilitar Computer ni permisos de captura. Se mantienen las restricciones de archivos existentes.",
