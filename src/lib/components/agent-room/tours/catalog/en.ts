...
export const TOURS_EN: Tour[] = [
  {"id":"pdf-ocr","icon":"FileText","title":"Read scanned PDFs with local OCR","tagline":"Import a scanned invoice, contract or printed report","steps":[{"id":"import","title":"Import a scan","body":"Drop a scanned PDF onto empty Canvas space or use Second Brain > Import files. Local OCR starts automatically; it needs no credentials or extra installation."},{"id":"inspect","title":"Inspect the evidence","body":"Open the source. Check the OCR page, recognition confidence and any partial/error notice against Open original. Use Refresh index to retry or split a large PDF."},{"id":"consult","title":"Ask your agent","body":"Ask: Find the amount and deadline in this PDF, cite the page and identify uncertain values. The agent uses the same indexed source and must not invent missing text."}]},
  {"id":"second-brain","icon":"BookMarked","title":"Second Brain: connected knowledge","tagline":"Turn documents and project work into cited, reusable knowledge.","steps":[{"id":"capture","title":"Gather your knowledge","body":"Add Second Brain to this workspace. Its sources and graph use the same notes, tasks and documents as Canvas and Workbench.","action":{"kind":"createKnowledge","title":"Second Brain: connected knowledge"},"check":{"kind":"nodeExists","nodeType":"knowledge"}},{"id":"import","title":"Import a document","body":"Drop a PDF, Markdown file or XLSX spreadsheet onto empty Canvas space, or choose Import files. Open its document node to inspect the extracted text and original. Scanned and mixed PDFs receive embedded English, Portuguese and Spanish OCR, with no account, upload or separate installation."},{"id":"connect","title":"Connect your notes","body":"This step creates a Campaign note. Link it to [[brief.pdf]] or connect their Canvas handles. In Knowledge graph, rotate in 3D or pan in 2D; click a point to read its source. The palette switches group/type colors. Changes arrive live without resetting your view.","action":{"kind":"createNote","title":"Campaign","content":"# Campaign\n\n[[brief.pdf]]\n\n#launch\n\nBudget: 450 USD\nDeadline: October 10"}},{"id":"consult","title":"Ask with evidence","body":"Ask your agent: Search the Second Brain for the budget and deadline, cite the page or cell, and create a plan. Edit the source and query again to verify the updated result."},{"id":"learn","title":"Retain useful lessons","body":"Open Second Brain > Agent learning. Select your specialist and choose Automatic, Review first or Off. After a tracked task, inspect its reusable lessons and evidence; activate, reject or archive them."}]},
