...
export const canvasNodeTypeSchema = z.enum(['terminal', 'note', 'fileTree', 'git', 'editor', 'diff', 'portal', 'apiClient', 'loop', 'group', 'shape', 'tasks', 'flow', 'image', 'imageWorkflow', 'usage', 'codeGraph', 'toolWorkshop', 'device', 'computer', 'design']);
