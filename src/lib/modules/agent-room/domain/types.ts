...
export type CanvasNodeType = 'terminal' | 'note' | 'fileTree' | 'git' | 'editor' | 'diff' | 'portal' | 'apiClient' | 'loop' | 'group' | 'shape' | 'tasks' | 'flow' | 'image' | 'imageWorkflow' | 'video' | 'videoWorkflow' | 'usage' | 'codeGraph' | 'controlCenter' | 'reviewCenter' | 'workstreams' | 'memory' | 'annotations' | 'huddles' | 'automation' | 'toolWorkshop' | 'device' | 'computer' | 'design';
