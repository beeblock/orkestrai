...
export async function run(argv, options = {}) {
  ...
  switch (command) {
    ...
    case 'video': {
      ...
      if (!['storyboards', 'characters', 'models', 'list', 'read', 'create', 'update', 'preview', 'run', 'cancel', 'retry_download', 'remove'].includes(command)) throw new Error('Unknown video command.');
