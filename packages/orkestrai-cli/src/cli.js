...
export async function run(argv, options = {}) {
  ...
  switch (command) {
    ...
    case 'graph': {
      ...
      throw new Error('Usage: orkestrai graph <status|index|changes|handoff|search|symbol|neighbors> ...');
    }
    case 'memory': {
