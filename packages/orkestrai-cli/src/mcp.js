...
const TOOLS = [
  ...
  { name: 'code_graph_search', description: 'Busca simbolos por nome, caminho, assinatura e documentacao. Use antes de ler vizinhanca e impacto.', inputSchema: { type: 'object', properties: { query: { type: 'string', minLength: 1, maxLength: 120 }, projectId: { type: 'string', format: 'uuid' }, kinds: { type: 'array', items: { type: 'string', enum: ['module', 'namespace', 'class', 'interface', 'type', 'enum', 'function', 'method', 'variable', 'endpoint', 'apiRequest', 'schema', 'gateway', 'resource', 'external'] } }, limit: { type: 'integer', minimum: 1, maximum: 100, default: 50 } }, required: ['query'] } },
