...
export const KNOWLEDGE_TOOLS = [
  ...
  tool('knowledge_read', 'Read a knowledge source with page/row/line locators and backlinks. Re-check revision/hash before using evidence. Unsupported or scanned files have no extracted content; never invent it.', { id: string }, ['id']),
